...
RSpec.describe 'Zitadel Client' do
  ...
  def create_user(base_url, client_id, client_secret)
    client = ZitadelClient::Zitadel.new(ZitadelClient::ClientCredentialsAuthenticator::builder(base_url, client_id, client_secret).build)
  ...
  describe 'with invalid token' do
    it 'does not deactivate or reactivate a user' do
      client = ZitadelClient::Zitadel.new(ZitadelClient::ClientCredentialsAuthenticator::builder(base_url, "id", "secret").build)
