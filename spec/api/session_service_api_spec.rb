...
describe 'SessionServiceApi' do
  ...
  # unit tests for session_service_create_session
  ...
  describe 'session_service_create_session test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for session_service_delete_session
  ...
  describe 'session_service_delete_session test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for session_service_get_session
  # Get a session
  ...
  describe 'session_service_get_session test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for session_service_list_sessions
  # Search sessions
  # Search for sessions
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [V2ListSessionsResponse]
  describe 'session_service_list_sessions test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for session_service_set_session
  ...
  describe 'session_service_set_session test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
