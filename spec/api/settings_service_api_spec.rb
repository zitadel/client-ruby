...
describe 'SettingsServiceApi' do
  ...
  # unit tests for settings_service_get_active_identity_providers
  ...
  describe 'settings_service_get_active_identity_providers test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for settings_service_get_branding_settings
  ...
  describe 'settings_service_get_branding_settings test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for settings_service_get_domain_settings
  ...
  describe 'settings_service_get_domain_settings test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for settings_service_get_general_settings
  # Get basic information over the instance
  # Return the basic information of the instance for the requested context
  # @param [Hash] opts the optional parameters
  # @return [V2GetGeneralSettingsResponse]
  describe 'settings_service_get_general_settings test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for settings_service_get_legal_and_support_settings
  ...
  describe 'settings_service_get_legal_and_support_settings test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for settings_service_get_lockout_settings
  ...
  describe 'settings_service_get_lockout_settings test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for settings_service_get_login_settings
  ...
  describe 'settings_service_get_login_settings test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for settings_service_get_password_complexity_settings
  ...
  describe 'settings_service_get_password_complexity_settings test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for settings_service_get_password_expiry_settings
  ...
  describe 'settings_service_get_password_expiry_settings test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
