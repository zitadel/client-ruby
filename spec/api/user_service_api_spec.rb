...
describe 'UserServiceApi' do
  ...
  describe 'add_idp_link test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for add_otp_email
  # Add OTP Email for a user
  # Add a new One-Time Password (OTP) Email factor to the authenticated user. OTP Email will enable the user to verify a OTP with the latest verified email. The email has to be verified to add the second factor..
  # @param user_id 
  # @param [Hash] opts the optional parameters
  # @return [V2AddOTPEmailResponse]
  describe 'add_otp_email test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for add_otpsms
  # Add OTP SMS for a user
  # Add a new One-Time Password (OTP) SMS factor to the authenticated user. OTP SMS will enable the user to verify a OTP with the latest verified phone number. The phone number has to be verified to add the second factor..
  # @param user_id 
  # @param [Hash] opts the optional parameters
  # @return [V2AddOTPSMSResponse]
  describe 'add_otpsms test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for create_invite_code
  ...
  describe 'create_invite_code test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for create_passkey_registration_link
  ...
  describe 'create_passkey_registration_link test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for human_mfa_init_skipped
  # MFA Init Skipped
  ...
  describe 'human_mfa_init_skipped test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_authentication_factors
  # @param user_id 
  # @param [Hash] opts the optional parameters
  ...
  describe 'list_authentication_factors test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_authentication_method_types
  ...
  describe 'list_authentication_method_types test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_idp_links
  ...
  describe 'list_idp_links test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_passkeys
  # List passkeys of an user
  # List passkeys of an user
  # @param user_id 
  # @param [Hash] opts the optional parameters
  # @return [V2ListPasskeysResponse]
  describe 'list_passkeys test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for register_passkey
  ...
  describe 'register_passkey test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for register_totp
  # Start the registration of a TOTP generator for a user
  # Start the registration of a TOTP generator for a user, as a response a secret returned, which is used to initialize a TOTP app or device..
  # @param user_id 
  # @param [Hash] opts the optional parameters
  # @return [V2RegisterTOTPResponse]
  describe 'register_totp test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for register_u2_f
  ...
  describe 'register_u2_f test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for remove_idp_link
  ...
  describe 'remove_idp_link test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for remove_otp_email
  # Remove One-Time Password (OTP) Email from a user
  # Remove the configured One-Time Password (OTP) Email factor of a user. As only one OTP Email per user is allowed, the user will not have OTP Email as a second factor afterward.
  # @param user_id 
  # @param [Hash] opts the optional parameters
  # @return [V2RemoveOTPEmailResponse]
  describe 'remove_otp_email test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for remove_otpsms
  # Remove One-Time Password (OTP) SMS from a user
  # Remove the configured One-Time Password (OTP) SMS factor of a user. As only one OTP SMS per user is allowed, the user will not have OTP SMS as a second factor afterward.
  # @param user_id 
  # @param [Hash] opts the optional parameters
  # @return [V2RemoveOTPSMSResponse]
  describe 'remove_otpsms test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for remove_passkey
  ...
  describe 'remove_passkey test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for remove_phone
  # Delete the user phone
  # Delete the phone number of a user.
  # @param user_id 
  # @param [Hash] opts the optional parameters
  # @return [V2RemovePhoneResponse]
  describe 'remove_phone test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for remove_totp
  # Remove TOTP generator from a user
  # Remove the configured TOTP generator of a user. As only one TOTP generator per user is allowed, the user will not have TOTP as a second factor afterward.
  # @param user_id 
  # @param [Hash] opts the optional parameters
  # @return [V2RemoveTOTPResponse]
  describe 'remove_totp test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for remove_u2_f
  ...
  describe 'remove_u2_f test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for resend_email_code
  ...
  describe 'resend_email_code test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for resend_invite_code
  ...
  describe 'resend_invite_code test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for resend_phone_code
  ...
  describe 'resend_phone_code test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for retrieve_identity_provider_intent
  ...
  describe 'retrieve_identity_provider_intent test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for send_email_code
  ...
  describe 'send_email_code test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for set_email
  ...
  describe 'set_phone test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for start_identity_provider_intent
  # Start flow with an identity provider
  # Start a flow with an identity provider, for external login, registration or linking..
  # @param body 
  # @param [Hash] opts the optional parameters
  # @return [V2StartIdentityProviderIntentResponse]
  describe 'start_identity_provider_intent test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for update_human_user
  # Update User
  ...
  describe 'update_human_user test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for verify_invite_code
  ...
  describe 'verify_invite_code test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for verify_passkey_registration
  ...
  describe 'verify_passkey_registration test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for verify_phone
  # Verify the phone
  ...
  describe 'verify_phone test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for verify_totp_registration
  ...
  describe 'verify_totp_registration test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for verify_u2_f_registration
  ...
  describe 'verify_u2_f_registration test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
