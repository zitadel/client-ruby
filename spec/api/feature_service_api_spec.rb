...
describe 'FeatureServiceApi' do
  ...
  # unit tests for feature_service_get_instance_features
  ...
  describe 'feature_service_get_instance_features test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for feature_service_get_organization_features
  ...
  describe 'feature_service_get_organization_features test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for feature_service_get_system_features
  ...
  describe 'feature_service_get_system_features test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for feature_service_get_user_features
  # Get organization level features
  # Returns all configured features for an organization. Unset fields mean the feature is the current instance default.
  # @param user_id 
  # @param [Hash] opts the optional parameters
  ...
  describe 'feature_service_get_user_features test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for feature_service_reset_instance_features
  ...
  describe 'feature_service_reset_instance_features test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for feature_service_reset_organization_features
  ...
  describe 'feature_service_reset_organization_features test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for feature_service_reset_system_features
  ...
  describe 'feature_service_reset_system_features test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for feature_service_reset_user_features
  ...
  describe 'feature_service_reset_user_features test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for feature_service_set_instance_features
  ...
  describe 'feature_service_set_instance_features test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for feature_service_set_organization_features
  # Set organization level features
  # Configure and set features that apply to a complete instance. Only fields present in the request are set or unset.
  # @param organization_id 
  # @param [Hash] opts the optional parameters
  # @return [V2SetOrganizationFeaturesResponse]
  describe 'feature_service_set_organization_features test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for feature_service_set_system_features
  ...
  describe 'feature_service_set_system_features test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for feature_service_set_user_features
  ...
  describe 'feature_service_set_user_features test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
