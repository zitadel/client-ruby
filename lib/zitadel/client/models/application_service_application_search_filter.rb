...
module Zitadel::Client
  ...
  module Models
    # Model class for ApplicationServiceApplicationSearchFilter.
    class ApplicationServiceApplicationSearchFilter < Dry::Struct
      ...
      # @example null
      attribute :client_id_filter, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :entity_id_filter, Types::Any.optional.meta(omittable: true)
      # @example null
      ...
      # @example null
      attribute :type_filter, Types::Any.optional.meta(omittable: true)
    end
  end
end
