...
module Zitadel::Client::Models
  ...
  class BetaOrganizationServiceDomainSearchFilter
    attr_accessor :domain_name_filter
    ...
    def self.openapi_types
      {
        :'domain_name_filter' => :'BetaOrganizationServiceDomainNameFilter'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::BetaOrganizationServiceDomainSearchFilter` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::BetaOrganizationServiceDomainSearchFilter`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'domain_name_filter')
        self.domain_name_filter = attributes[:'domain_name_filter']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          domain_name_filter == o.domain_name_filter
    end
