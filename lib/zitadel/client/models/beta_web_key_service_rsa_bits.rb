...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaWebKeyServiceRSABits.
    class BetaWebKeyServiceRSABits
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaWebKeyServiceRSABits: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
