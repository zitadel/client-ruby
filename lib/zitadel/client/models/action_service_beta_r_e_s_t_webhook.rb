...
module Zitadel::Client::Models
  class ActionServiceBetaRESTWebhook
    # Define if any error stops the whole execution. By default the process continues as normal.
    attr_accessor :interrupt_on_error

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'interrupt_on_error' => :'interruptOnError'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::ActionServiceBetaRESTWebhook` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::ActionServiceBetaRESTWebhook`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'interrupt_on_error')
        self.interrupt_on_error = attributes[:'interrupt_on_error']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          interrupt_on_error == o.interrupt_on_error
    end
