...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for ActionServiceTargetFieldName.
    class ActionServiceTargetFieldName
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for ActionServiceTargetFieldName: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
