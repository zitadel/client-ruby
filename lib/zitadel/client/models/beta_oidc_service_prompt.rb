...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaOIDCServicePrompt.
    class BetaOIDCServicePrompt
      ...
      VALUES = [PROMPT_UNSPECIFIED, PROMPT_NONE, PROMPT_LOGIN, PROMPT_CONSENT, PROMPT_SELECT_ACCOUNT, PROMPT_CREATE].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaOIDCServicePrompt: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
