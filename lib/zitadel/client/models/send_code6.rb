...
module Zitadel::Client::Models
  class SendCode6
    ...
    def self.openapi_types
      {
        :'send_code' => :'BetaUserServiceSendPhoneVerificationCode'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::SendCode6` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::SendCode6`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @send_code.nil?
        invalid_properties.push('invalid value for "send_code", send_code cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @send_code.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [BetaUserServiceSendPhoneVerificationCode] send_code Value to be assigned
    def send_code=(send_code)
      if send_code.nil?
        fail ArgumentError, 'send_code cannot be nil'
      end
