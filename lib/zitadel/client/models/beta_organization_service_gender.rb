...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaOrganizationServiceGender.
    class BetaOrganizationServiceGender
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaOrganizationServiceGender: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
