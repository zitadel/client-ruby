...
module Zitadel::Client::Models
    ...
    def self.openapi_types
      {
        :'app_id' => :'String',
        :'creation_date' => :'Time',
        :'api_response' => :'BetaAppServiceCreateAPIApplicationResponse',
        :'oidc_response' => :'BetaAppServiceCreateOIDCApplicationResponse',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::BetaAppServiceCreateApplicationResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::BetaAppServiceCreateApplicationResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'api_response')
        self.api_response = attributes[:'api_response']
      end

      if attributes.key?(:'oidc_response')
        self.oidc_response = attributes[:'oidc_response']
      end
    ...
    def hash
      [app_id, creation_date, api_response, oidc_response, saml_response].hash
    end
