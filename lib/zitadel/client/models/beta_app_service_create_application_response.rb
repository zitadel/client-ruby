...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaAppServiceCreateApplicationResponse.
    class BetaAppServiceCreateApplicationResponse < Dry::Struct
      ...
      # @example null
      attribute :app_id, Types::Any.optional.meta(omittable: true)
      ...
      # @example null
      attribute :api_response, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :oidc_response, Types::Any.optional.meta(omittable: true)
      # @example null
