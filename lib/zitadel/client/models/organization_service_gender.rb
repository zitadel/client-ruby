...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for OrganizationServiceGender.
    class OrganizationServiceGender
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for OrganizationServiceGender: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
