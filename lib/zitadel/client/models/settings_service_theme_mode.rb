...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for SettingsServiceThemeMode.
    class SettingsServiceThemeMode
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for SettingsServiceThemeMode: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
