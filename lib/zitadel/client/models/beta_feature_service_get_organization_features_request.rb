...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaFeatureServiceGetOrganizationFeaturesRequest.
    class BetaFeatureServiceGetOrganizationFeaturesRequest < Dry::Struct
      ...
      # @example null
      attribute :inheritance, Types::Any.optional.meta(omittable: true)
    end
  end
end
