...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaUserServiceRegisterPasskeyRequest.
    class BetaUserServiceRegisterPasskeyRequest < Dry::Struct
      ...
      # @example null
      attribute :authenticator, Types::Any.optional.meta(omittable: true)
      # @example null
