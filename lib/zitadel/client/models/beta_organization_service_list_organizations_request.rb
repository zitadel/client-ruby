...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaOrganizationServiceListOrganizationsRequest.
    class BetaOrganizationServiceListOrganizationsRequest < Dry::Struct
      ...
      # @example null
      attribute :filter, Types::Any.optional.meta(omittable: true)
    end
  end
end
