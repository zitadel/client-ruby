...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for OIDCServiceErrorReason.
    class OIDCServiceErrorReason
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for OIDCServiceErrorReason: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
