...
module Zitadel::Client
  ...
  module Models
    # Model class for UserServiceRemoveIDPLinkRequest.
    class UserServiceRemoveIDPLinkRequest < Dry::Struct
      ...
      # @example null
      attribute :linked_user_id, Types::Any.optional.meta(omittable: true)
    end
  end
end
