...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaUserServiceIDPSAMLAccessInformation.
    class BetaUserServiceIDPSAMLAccessInformation < Dry::Struct
      ...
      # @example null
      attribute :assertion, Types::Any.optional.meta(omittable: true)
    end
  end
end
