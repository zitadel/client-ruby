...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaFeatureServiceImprovedPerformanceFeatureFlag.
    class BetaFeatureServiceImprovedPerformanceFeatureFlag < Dry::Struct
      ...
      # @example null
      attribute :execution_paths, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :source, Types::Any.optional.meta(omittable: true)
    end
  end
end
