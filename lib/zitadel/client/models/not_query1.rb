  ...
  class NotQuery1
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::NotQuery1` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::NotQuery1`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @not_query.nil?
        invalid_properties.push('invalid value for "not_query", not_query cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @not_query.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [BetaUserServiceNotQuery] not_query Value to be assigned
    def not_query=(not_query)
      if not_query.nil?
        fail ArgumentError, 'not_query cannot be nil'
      end
