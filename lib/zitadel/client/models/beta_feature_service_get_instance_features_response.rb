  ...
  class BetaFeatureServiceGetInstanceFeaturesResponse
    ...
    def self.openapi_types
      {
        ...
        :'login_default_org' => :'BetaFeatureServiceFeatureFlag',
        :'oidc_trigger_introspection_projections' => :'BetaFeatureServiceFeatureFlag',
        :'oidc_legacy_introspection' => :'BetaFeatureServiceFeatureFlag',
        :'user_schema' => :'BetaFeatureServiceFeatureFlag',
        :'oidc_token_exchange' => :'BetaFeatureServiceFeatureFlag',
        :'improved_performance' => :'BetaFeatureServiceImprovedPerformanceFeatureFlag',
        :'web_key' => :'BetaFeatureServiceFeatureFlag',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::BetaFeatureServiceGetInstanceFeaturesResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::BetaFeatureServiceGetInstanceFeaturesResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [details, login_default_org, oidc_trigger_introspection_projections, oidc_legacy_introspection, user_schema, oidc_token_exchange, improved_performance, web_key, debug_oidc_parent_error, oidc_single_v1_session_termination].hash
    end
