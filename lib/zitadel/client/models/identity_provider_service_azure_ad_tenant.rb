...
module Zitadel::Client
  ...
  module Models
    # Model class for IdentityProviderServiceAzureADTenant.
    class IdentityProviderServiceAzureADTenant < Dry::Struct
      ...
      # @example null
      attribute :tenant_id, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :tenant_type, Types::Any.optional.meta(omittable: true)
    end
  end
end
