  ...
  class AzureAd
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::AzureAd` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::AzureAd`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @azure_ad.nil?
        invalid_properties.push('invalid value for "azure_ad", azure_ad cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @azure_ad.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [IdentityProviderServiceAzureADConfig] azure_ad Value to be assigned
    def azure_ad=(azure_ad)
      if azure_ad.nil?
        fail ArgumentError, 'azure_ad cannot be nil'
      end
