...
module Zitadel::Client::Models
  class OtpSms
    ...
    def self.openapi_types
      {
        :'otp_sms' => :'UserServiceAuthFactorOTPSMS'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::OtpSms` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::OtpSms`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @otp_sms.nil?
        invalid_properties.push('invalid value for "otp_sms", otp_sms cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @otp_sms.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [UserServiceAuthFactorOTPSMS] otp_sms Value to be assigned
    def otp_sms=(otp_sms)
      if otp_sms.nil?
        fail ArgumentError, 'otp_sms cannot be nil'
      end
