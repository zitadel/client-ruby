...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for UserServiceAuthFactors.
    class UserServiceAuthFactors
      ...
      VALUES = [OTP, OTP_SMS, OTP_EMAIL, U2_F].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for UserServiceAuthFactors: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
