...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaSettingsServiceResourceOwnerType.
    class BetaSettingsServiceResourceOwnerType
      ...
      VALUES = [RESOURCE_OWNER_TYPE_UNSPECIFIED, RESOURCE_OWNER_TYPE_INSTANCE, RESOURCE_OWNER_TYPE_ORG].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaSettingsServiceResourceOwnerType: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
