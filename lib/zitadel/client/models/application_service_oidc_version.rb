...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for ApplicationServiceOIDCVersion.
    class ApplicationServiceOIDCVersion
      OIDC_VERSION_1_0 = 'OIDC_VERSION_1_0'

      # Frozen set of all allowed values, used for validation.
      VALUES = [OIDC_VERSION_1_0].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for ApplicationServiceOIDCVersion: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
