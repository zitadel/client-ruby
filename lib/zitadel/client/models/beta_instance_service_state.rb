...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaInstanceServiceState.
    class BetaInstanceServiceState
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaInstanceServiceState: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
