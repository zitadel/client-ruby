...
module Zitadel::Client::Models
    ...
    attr_accessor :display_name_filter
    ...
    def self.openapi_types
      {
        :'display_name_filter' => :'BetaProjectServiceProjectRoleDisplayNameFilter',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::BetaProjectServiceProjectRoleSearchFilter` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::BetaProjectServiceProjectRoleSearchFilter`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'display_name_filter')
        self.display_name_filter = attributes[:'display_name_filter']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          display_name_filter == o.display_name_filter &&
    ...
    def hash
      [display_name_filter, role_key_filter].hash
    end
