...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaProjectServiceProjectRoleSearchFilter.
    class BetaProjectServiceProjectRoleSearchFilter < Dry::Struct
      ...
      # @example null
      attribute :display_name_filter, Types::Any.optional.meta(omittable: true)
      # @example null
