...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaOIDCServiceGetAuthRequestResponse.
    class BetaOIDCServiceGetAuthRequestResponse < Dry::Struct
      ...
      # @example null
      attribute :auth_request, Types::Any.optional.meta(omittable: true)
    end
  end
end
