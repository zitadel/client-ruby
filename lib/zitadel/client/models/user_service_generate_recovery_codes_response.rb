...
module Zitadel::Client
  ...
  module Models
    # Model class for UserServiceGenerateRecoveryCodesResponse.
    class UserServiceGenerateRecoveryCodesResponse < Dry::Struct
      ...
      # @example null
      attribute :recovery_codes, Types::Any.optional.meta(omittable: true)
    end
  end
end
