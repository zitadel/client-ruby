...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for ApplicationServiceApplicationType.
    class ApplicationServiceApplicationType
      ...
      VALUES = [APPLICATION_TYPE_UNSPECIFIED, APPLICATION_TYPE_OIDC, APPLICATION_TYPE_API, APPLICATION_TYPE_SAML].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for ApplicationServiceApplicationType: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
