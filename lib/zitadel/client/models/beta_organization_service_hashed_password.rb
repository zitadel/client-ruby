...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaOrganizationServiceHashedPassword.
    class BetaOrganizationServiceHashedPassword < Dry::Struct
      ...
      # @example null
      attribute :hash, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :change_required, Types::Any.optional.meta(omittable: true)
    end
  end
end
