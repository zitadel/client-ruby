...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaSettingsServiceGetPasswordComplexitySettingsResponse.
    class BetaSettingsServiceGetPasswordComplexitySettingsResponse < Dry::Struct
      ...
      # @example null
      attribute :settings, Types::Any.optional.meta(omittable: true)
    end
  end
end
