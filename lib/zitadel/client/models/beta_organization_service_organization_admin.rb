...
module Zitadel::Client::Models
    ...
    def self.openapi_types
      {
        :'assigned_admin' => :'BetaOrganizationServiceAssignedAdmin',
        :'created_admin' => :'BetaOrganizationServiceCreatedAdmin'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::BetaOrganizationServiceOrganizationAdmin` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::BetaOrganizationServiceOrganizationAdmin`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'assigned_admin')
        self.assigned_admin = attributes[:'assigned_admin']
      end

      if attributes.key?(:'created_admin')
        self.created_admin = attributes[:'created_admin']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          assigned_admin == o.assigned_admin &&
          created_admin == o.created_admin
    end
    ...
    def hash
      [assigned_admin, created_admin].hash
    end
