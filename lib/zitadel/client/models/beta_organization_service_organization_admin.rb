...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaOrganizationServiceOrganizationAdmin.
    class BetaOrganizationServiceOrganizationAdmin < Dry::Struct
      ...
      # @example null
      attribute :assigned_admin, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :created_admin, Types::Any.optional.meta(omittable: true)
    end
  end
end
