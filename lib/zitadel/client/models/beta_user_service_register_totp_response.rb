...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaUserServiceRegisterTOTPResponse.
    class BetaUserServiceRegisterTOTPResponse < Dry::Struct
      ...
      # @example null
      attribute :uri, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :secret, Types::Any.optional.meta(omittable: true)
    end
  end
end
