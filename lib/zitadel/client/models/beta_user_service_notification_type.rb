...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaUserServiceNotificationType.
    class BetaUserServiceNotificationType
      ...
      VALUES = [NOTIFICATION_TYPE_UNSPECIFIED, NOTIFICATION_TYPE_EMAIL, NOTIFICATION_TYPE_SMS].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaUserServiceNotificationType: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
