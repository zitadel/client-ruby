...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for IdentityProviderServiceAutoLinkingOption.
    class IdentityProviderServiceAutoLinkingOption
      ...
      VALUES = [AUTO_LINKING_OPTION_UNSPECIFIED, AUTO_LINKING_OPTION_USERNAME, AUTO_LINKING_OPTION_EMAIL].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for IdentityProviderServiceAutoLinkingOption: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
