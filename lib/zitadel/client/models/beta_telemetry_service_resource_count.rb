...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaTelemetryServiceResourceCount.
    class BetaTelemetryServiceResourceCount < Dry::Struct
      ...
      # @example null
      attribute :parent_type, Types::Any.optional.meta(omittable: true)
      ...
      # @example null
      attribute :parent_id, Types::Any.optional.meta(omittable: true)
      # The resource counts to report, e.g. amount of `users`, `organizations`, etc.
      # @example null
      attribute :resource_name, Types::Any.optional.meta(omittable: true)
      ...
      # @example null
      attribute :table_name, Types::Any.optional.meta(omittable: true)
      ...
      # @example null
      attribute :updated_at, Types::Any.optional.meta(omittable: true)
      # The actual amount of the resource.
      # @example null
      attribute :amount, Types::Any.optional.meta(omittable: true)
    end
  end
end
