...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaWebKeyServiceRSAHasher.
    class BetaWebKeyServiceRSAHasher
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaWebKeyServiceRSAHasher: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
