...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaProjectServiceListProjectsResponse.
    class BetaProjectServiceListProjectsResponse < Dry::Struct
      ...
      # @example null
      attribute :projects, Types::Any.optional.meta(omittable: true)
    end
  end
end
