...
module Zitadel::Client
  ...
  module Models
    # Model class for ApplicationServiceLoginVersion.
    class ApplicationServiceLoginVersion < Dry::Struct
      ...
      # @example null
      attribute :login_v1, Types::Any.optional.meta(omittable: true)
      # @example null
