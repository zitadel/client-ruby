...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for InstanceServiceFieldName.
    class InstanceServiceFieldName
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for InstanceServiceFieldName: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
