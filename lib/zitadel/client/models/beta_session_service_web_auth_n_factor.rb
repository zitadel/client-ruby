...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaSessionServiceWebAuthNFactor.
    class BetaSessionServiceWebAuthNFactor < Dry::Struct
      ...
      # @example null
      attribute :verified_at, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :user_verified, Types::Any.optional.meta(omittable: true)
    end
  end
end
