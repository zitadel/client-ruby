...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for WebKeyServiceRSAHasher.
    class WebKeyServiceRSAHasher
      ...
      VALUES = [RSA_HASHER_UNSPECIFIED, RSA_HASHER_SHA256, RSA_HASHER_SHA384, RSA_HASHER_SHA512].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for WebKeyServiceRSAHasher: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
