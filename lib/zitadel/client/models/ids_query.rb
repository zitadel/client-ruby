...
module Zitadel::Client::Models
  class IdsQuery
    ...
    def self.openapi_types
      {
        :'ids_query' => :'BetaSessionServiceIDsQuery'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::IdsQuery` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::IdsQuery`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @ids_query.nil?
        invalid_properties.push('invalid value for "ids_query", ids_query cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ids_query.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [BetaSessionServiceIDsQuery] ids_query Value to be assigned
    def ids_query=(ids_query)
      if ids_query.nil?
        fail ArgumentError, 'ids_query cannot be nil'
      end
