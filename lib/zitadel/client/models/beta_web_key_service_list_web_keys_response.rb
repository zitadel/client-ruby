...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaWebKeyServiceListWebKeysResponse.
    class BetaWebKeyServiceListWebKeysResponse < Dry::Struct
      ...
      # @example null
      attribute :web_keys, Types::Any.optional.meta(omittable: true)
    end
  end
end
