...
module Zitadel::Client
  ...
  module Models
    # Model class for OrganizationServiceAddOrganizationResponse.
    class OrganizationServiceAddOrganizationResponse < Dry::Struct
      ...
      # @example null
      attribute :created_admins, Types::Any.optional.meta(omittable: true)
    end
  end
end
