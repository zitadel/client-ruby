...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for OrganizationServiceDomainFieldName.
    class OrganizationServiceDomainFieldName
      ...
      VALUES = [DOMAIN_FIELD_NAME_UNSPECIFIED, DOMAIN_FIELD_NAME_NAME, DOMAIN_FIELD_NAME_CREATION_DATE].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for OrganizationServiceDomainFieldName: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
