...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for ApplicationServiceOIDCResponseType.
    class ApplicationServiceOIDCResponseType
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for ApplicationServiceOIDCResponseType: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
