...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaAppServiceGetApplicationResponse.
    class BetaAppServiceGetApplicationResponse < Dry::Struct
      ...
      # @example null
      attribute :app, Types::Any.optional.meta(omittable: true)
    end
  end
end
