...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaTelemetryServiceCountParentType.
    class BetaTelemetryServiceCountParentType
      ...
      VALUES = [COUNT_PARENT_TYPE_UNSPECIFIED, COUNT_PARENT_TYPE_INSTANCE, COUNT_PARENT_TYPE_ORGANIZATION].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaTelemetryServiceCountParentType: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
