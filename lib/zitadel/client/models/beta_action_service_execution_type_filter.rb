...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaActionServiceExecutionTypeFilter.
    class BetaActionServiceExecutionTypeFilter < Dry::Struct
      ...
      # @example null
      attribute :execution_type, Types::Any.optional.meta(omittable: true)
    end
  end
end
