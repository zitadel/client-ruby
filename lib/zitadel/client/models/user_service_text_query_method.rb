...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for UserServiceTextQueryMethod.
    class UserServiceTextQueryMethod
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for UserServiceTextQueryMethod: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
