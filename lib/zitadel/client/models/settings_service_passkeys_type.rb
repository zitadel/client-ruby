...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for SettingsServicePasskeysType.
    class SettingsServicePasskeysType
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for SettingsServicePasskeysType: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
