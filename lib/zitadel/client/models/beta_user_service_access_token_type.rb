...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaUserServiceAccessTokenType.
    class BetaUserServiceAccessTokenType
      ...
      VALUES = [ACCESS_TOKEN_TYPE_BEARER, ACCESS_TOKEN_TYPE_JWT].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaUserServiceAccessTokenType: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
