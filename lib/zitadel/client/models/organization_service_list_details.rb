...
module Zitadel::Client
  ...
  module Models
    # Model class for OrganizationServiceListDetails.
    class OrganizationServiceListDetails < Dry::Struct
      ...
      # @example null
      attribute :processed_sequence, Types::Any.optional.meta(omittable: true)
      ...
      # @example null
      attribute :timestamp, Types::Any.optional.meta(omittable: true)
    end
  end
end
