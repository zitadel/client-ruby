...
module Zitadel::Client
  ...
  module Models
    # Model class for ApplicationServiceOIDCLocalizedMessage.
    class ApplicationServiceOIDCLocalizedMessage < Dry::Struct
      ...
      # @example null
      attribute :localized_message, Types::Any.optional.meta(omittable: true)
    end
  end
end
