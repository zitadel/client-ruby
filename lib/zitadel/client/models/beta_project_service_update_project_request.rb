...
module Zitadel::Client::Models
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::BetaProjectServiceUpdateProjectRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::BetaProjectServiceUpdateProjectRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'project_role_check')
        self.project_role_check = attributes[:'project_role_check']
      end

      if attributes.key?(:'has_project_check')
        self.has_project_check = attributes[:'has_project_check']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          project_role_check == o.project_role_check &&
          has_project_check == o.has_project_check &&
    ...
    def hash
      [id, name, project_role_assertion, project_role_check, has_project_check, private_labeling_setting].hash
    end
