...
module Zitadel::Client::Models
    ...
    attr_accessor :none_compliant

    attr_accessor :compliance_problems
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::BetaAppServiceOIDCConfig` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::BetaAppServiceOIDCConfig`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'none_compliant')
        self.none_compliant = attributes[:'none_compliant']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          version == o.version &&
          none_compliant == o.none_compliant &&
