...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for UserServiceUserState.
    class UserServiceUserState
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for UserServiceUserState: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
