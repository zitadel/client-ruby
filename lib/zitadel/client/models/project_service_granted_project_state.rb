...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for ProjectServiceGrantedProjectState.
    class ProjectServiceGrantedProjectState
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for ProjectServiceGrantedProjectState: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
