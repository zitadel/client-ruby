...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaSettingsServicePasskeysType.
    class BetaSettingsServicePasskeysType
      ...
      VALUES = [PASSKEYS_TYPE_NOT_ALLOWED, PASSKEYS_TYPE_ALLOWED].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaSettingsServicePasskeysType: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
