...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaOrganizationServiceMetadataQuery.
    class BetaOrganizationServiceMetadataQuery < Dry::Struct
      ...
      # @example null
      attribute :key_query, Types::Any.optional.meta(omittable: true)
    end
  end
end
