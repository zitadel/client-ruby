...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for OrganizationServiceTextQueryMethod.
    class OrganizationServiceTextQueryMethod
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for OrganizationServiceTextQueryMethod: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
