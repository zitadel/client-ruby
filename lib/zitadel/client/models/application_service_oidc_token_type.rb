...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for ApplicationServiceOIDCTokenType.
    class ApplicationServiceOIDCTokenType
      ...
      VALUES = [OIDC_TOKEN_TYPE_BEARER, OIDC_TOKEN_TYPE_JWT].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for ApplicationServiceOIDCTokenType: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
