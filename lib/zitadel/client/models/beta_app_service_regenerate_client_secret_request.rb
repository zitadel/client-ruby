...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaAppServiceRegenerateClientSecretRequest.
    class BetaAppServiceRegenerateClientSecretRequest < Dry::Struct
      ...
      # @example null
      attribute :is_api, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :is_oidc, Types::Any.optional.meta(omittable: true)
    end
  end
end
