...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaAppServiceAppSorting.
    class BetaAppServiceAppSorting
      ...
      VALUES = [APP_SORT_BY_ID, APP_SORT_BY_NAME, APP_SORT_BY_STATE, APP_SORT_BY_CREATION_DATE, APP_SORT_BY_CHANGE_DATE].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaAppServiceAppSorting: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
