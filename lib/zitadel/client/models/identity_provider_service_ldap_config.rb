...
module Zitadel::Client
  ...
  module Models
    # Model class for IdentityProviderServiceLDAPConfig.
    class IdentityProviderServiceLDAPConfig < Dry::Struct
      ...
      # @example null
      attribute :servers, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :start_tls, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :base_dn, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :bind_dn, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :user_base, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :user_object_classes, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :user_filters, Types::Any.optional.meta(omittable: true)
      ...
      # @example null
      attribute :timeout, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :attributes, Types::Any.optional.meta(omittable: true)
      # @example null
