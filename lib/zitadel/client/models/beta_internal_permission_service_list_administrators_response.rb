...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaInternalPermissionServiceListAdministratorsResponse.
    class BetaInternalPermissionServiceListAdministratorsResponse < Dry::Struct
      ...
      # @example null
      attribute :administrators, Types::Any.optional.meta(omittable: true)
    end
  end
end
