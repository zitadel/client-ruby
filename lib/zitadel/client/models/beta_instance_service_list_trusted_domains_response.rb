...
module Zitadel::Client::Models
    ...
    def self.openapi_types
      {
        :'trusted_domain' => :'Array<BetaInstanceServiceTrustedDomain>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::BetaInstanceServiceListTrustedDomainsResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::BetaInstanceServiceListTrustedDomainsResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'trusted_domain')
        if (value = attributes[:'trusted_domain']).is_a?(Array)
          self.trusted_domain = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          trusted_domain == o.trusted_domain &&
    ...
    def hash
      [trusted_domain, pagination].hash
    end
