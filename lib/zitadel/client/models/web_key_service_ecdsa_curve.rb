...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for WebKeyServiceECDSACurve.
    class WebKeyServiceECDSACurve
      ...
      VALUES = [ECDSA_CURVE_UNSPECIFIED, ECDSA_CURVE_P256, ECDSA_CURVE_P384, ECDSA_CURVE_P512].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for WebKeyServiceECDSACurve: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
