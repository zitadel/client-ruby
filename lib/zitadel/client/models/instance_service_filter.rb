...
module Zitadel::Client
  ...
  module Models
    # Model class for InstanceServiceFilter.
    class InstanceServiceFilter < Dry::Struct
      ...
      # @example null
      attribute :custom_domains_filter, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :in_ids_filter, Types::Any.optional.meta(omittable: true)
    end
  end
end
