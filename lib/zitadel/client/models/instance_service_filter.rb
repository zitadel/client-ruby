...
module Zitadel::Client::Models
    ...
    attr_accessor :custom_domains_filter

    attr_accessor :in_ids_filter

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'custom_domains_filter' => :'customDomainsFilter',
        :'in_ids_filter' => :'inIdsFilter'
      }
    end
    ...
    def self.openapi_types
      {
        :'custom_domains_filter' => :'InstanceServiceCustomDomainsFilter',
        :'in_ids_filter' => :'InstanceServiceInIDsFilter'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::InstanceServiceFilter` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::InstanceServiceFilter`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'custom_domains_filter')
        self.custom_domains_filter = attributes[:'custom_domains_filter']
      end

      if attributes.key?(:'in_ids_filter')
        self.in_ids_filter = attributes[:'in_ids_filter']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          custom_domains_filter == o.custom_domains_filter &&
          in_ids_filter == o.in_ids_filter
    end
    ...
    def hash
      [custom_domains_filter, in_ids_filter].hash
    end
