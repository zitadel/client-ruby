...
module Zitadel::Client
  ...
  module Models
    # Model class for UserServiceGenerateRecoveryCodesRequest.
    class UserServiceGenerateRecoveryCodesRequest < Dry::Struct
      ...
      # @example null
      attribute :count, Types::Any.optional.meta(omittable: true)
    end
  end
end
