...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaUserServiceCreatePasskeyRegistrationLinkRequest.
    class BetaUserServiceCreatePasskeyRegistrationLinkRequest < Dry::Struct
      ...
      # @example null
      attribute :send_link, Types::Any.optional.meta(omittable: true)
    end
  end
end
