...
module Zitadel::Client
  ...
  module Models
    # Model class for IdentityProviderServiceGetIDPByIDResponse.
    class IdentityProviderServiceGetIDPByIDResponse < Dry::Struct
      ...
      # @example null
      attribute :idp, Types::Any.optional.meta(omittable: true)
    end
  end
end
