...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for WebKeyServiceState.
    class WebKeyServiceState
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for WebKeyServiceState: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
