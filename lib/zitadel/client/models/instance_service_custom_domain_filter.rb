...
module Zitadel::Client::Models
    ...
    def self.openapi_types
      {
        :'domain_filter' => :'InstanceServiceDomainFilter',
        :'generated_filter' => :'Boolean',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::InstanceServiceCustomDomainFilter` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::InstanceServiceCustomDomainFilter`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'generated_filter')
        self.generated_filter = attributes[:'generated_filter']
      end

      if attributes.key?(:'primary_filter')
        self.primary_filter = attributes[:'primary_filter']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          generated_filter == o.generated_filter &&
          primary_filter == o.primary_filter
    end
    ...
    def hash
      [domain_filter, generated_filter, primary_filter].hash
    end
