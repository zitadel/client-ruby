...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for FeatureServiceSource.
    class FeatureServiceSource
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for FeatureServiceSource: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
