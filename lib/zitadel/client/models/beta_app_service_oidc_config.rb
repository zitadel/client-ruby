...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaAppServiceOIDCConfig.
    class BetaAppServiceOIDCConfig < Dry::Struct
      ...
      OPENAPI_TYPES = {
        ...
        compliance_problems: 'Array<BetaAppServiceOIDCLocalizedMessage>',
        dev_mode: 'Boolean',
      ...
      # @example null
      attribute :none_compliant, Types::Any.optional.meta(omittable: true)
      # @example null
