...
module Zitadel::Client::Models
    ...
    attr_accessor :ignore_inheritance
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::SettingsServiceGetHostedLoginTranslationRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::SettingsServiceGetHostedLoginTranslationRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'ignore_inheritance')
        self.ignore_inheritance = attributes[:'ignore_inheritance']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          locale == o.locale &&
          ignore_inheritance == o.ignore_inheritance &&
          instance == o.instance &&
    ...
    def hash
      [locale, ignore_inheritance, instance, organization_id, system].hash
    end
