...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaUserServiceGender.
    class BetaUserServiceGender
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaUserServiceGender: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
