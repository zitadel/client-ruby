...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaInstanceServiceDomainFieldName.
    class BetaInstanceServiceDomainFieldName
      ...
      VALUES = [DOMAIN_FIELD_NAME_UNSPECIFIED, DOMAIN_FIELD_NAME_DOMAIN, DOMAIN_FIELD_NAME_PRIMARY, DOMAIN_FIELD_NAME_GENERATED, DOMAIN_FIELD_NAME_CREATION_DATE].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaInstanceServiceDomainFieldName: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
