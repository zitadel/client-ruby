...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaOrganizationServiceListOrganizationsResponse.
    class BetaOrganizationServiceListOrganizationsResponse < Dry::Struct
      ...
      # @example null
      attribute :organizations, Types::Any.optional.meta(omittable: true)
    end
  end
end
