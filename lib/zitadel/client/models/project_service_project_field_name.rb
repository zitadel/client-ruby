...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for ProjectServiceProjectFieldName.
    class ProjectServiceProjectFieldName
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for ProjectServiceProjectFieldName: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
