...
module Zitadel::Client
  ...
  module Models
    # Model class for ActionServiceListPublicKeysResponse.
    class ActionServiceListPublicKeysResponse < Dry::Struct
      ...
      # @example null
      attribute :public_keys, Types::Any.optional.meta(omittable: true)
    end
  end
end
