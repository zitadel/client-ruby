  ...
  class Saml2
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::Saml2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::Saml2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @saml.nil?
        invalid_properties.push('invalid value for "saml", saml cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @saml.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [BetaUserServiceIDPSAMLAccessInformation] saml Value to be assigned
    def saml=(saml)
      if saml.nil?
        fail ArgumentError, 'saml cannot be nil'
      end
