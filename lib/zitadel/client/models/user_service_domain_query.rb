...
module Zitadel::Client::Models
    ...
    attr_accessor :include_without_domain
    ...
    def self.attribute_map
      {
        :'include_without_domain' => :'includeWithoutDomain',
        :'domain' => :'domain'
      }
    end
    ...
    def self.openapi_types
      {
        :'include_without_domain' => :'Boolean',
        :'domain' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::UserServiceDomainQuery` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::UserServiceDomainQuery`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'include_without_domain')
        self.include_without_domain = attributes[:'include_without_domain']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          include_without_domain == o.include_without_domain &&
          domain == o.domain
    end
    ...
    def hash
      [include_without_domain, domain].hash
    end
