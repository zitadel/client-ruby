...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for OrganizationServiceOrganizationFieldName.
    class OrganizationServiceOrganizationFieldName
      ...
      VALUES = [ORGANIZATION_FIELD_NAME_UNSPECIFIED, ORGANIZATION_FIELD_NAME_NAME, ORGANIZATION_FIELD_NAME_CREATION_DATE].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for OrganizationServiceOrganizationFieldName: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
