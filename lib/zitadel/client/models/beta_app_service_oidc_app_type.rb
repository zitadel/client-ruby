...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaAppServiceOIDCAppType.
    class BetaAppServiceOIDCAppType
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaAppServiceOIDCAppType: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
