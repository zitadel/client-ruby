...
module Zitadel::Client::Models
    ...
    def self.openapi_types
      {
        :'system_id' => :'String',
        :'report_id' => :'String',
        :'resource_counts' => :'Array<BetaTelemetryServiceResourceCount>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::BetaTelemetryServiceReportResourceCountsRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::BetaTelemetryServiceReportResourceCountsRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'resource_counts')
        if (value = attributes[:'resource_counts']).is_a?(Array)
          self.resource_counts = value
        end
      end
    end
    ...
    def hash
      [system_id, report_id, resource_counts].hash
    end
