...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for SettingsServiceMultiFactorType.
    class SettingsServiceMultiFactorType
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for SettingsServiceMultiFactorType: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
