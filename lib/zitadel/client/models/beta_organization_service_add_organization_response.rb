...
module Zitadel::Client::Models
  class BetaOrganizationServiceAddOrganizationResponse
    attr_accessor :details

    attr_accessor :organization_id

    attr_accessor :created_admins
    ...
    def self.openapi_types
      {
        ...
        :'created_admins' => :'Array<BetaOrganizationServiceCreatedAdmin>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::BetaOrganizationServiceAddOrganizationResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::BetaOrganizationServiceAddOrganizationResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'created_admins')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          created_admins == o.created_admins
    end
