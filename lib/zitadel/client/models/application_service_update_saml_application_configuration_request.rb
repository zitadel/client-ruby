...
module Zitadel::Client
  ...
  module Models
    # Model class for ApplicationServiceUpdateSAMLApplicationConfigurationRequest.
    class ApplicationServiceUpdateSAMLApplicationConfigurationRequest < Dry::Struct
