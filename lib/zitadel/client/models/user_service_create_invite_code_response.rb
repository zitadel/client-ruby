...
module Zitadel::Client
  ...
  module Models
    # Model class for UserServiceCreateInviteCodeResponse.
    class UserServiceCreateInviteCodeResponse < Dry::Struct
      ...
      # @example null
      attribute :invite_code, Types::Any.optional.meta(omittable: true)
    end
  end
end
