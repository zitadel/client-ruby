...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaAuthorizationServiceAuthorization.
    class BetaAuthorizationServiceAuthorization < Dry::Struct
      ...
      # @example null
      attribute :project_organization_id, Types::Any.optional.meta(omittable: true)
