...
module Zitadel::Client::Models
        class BetaAuthorizationServiceAuthorization
    ...
    attr_accessor :project_organization_id
    ...
    def self.attribute_map
      {
        ...
        :'project_organization_id' => :'projectOrganizationId',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::BetaAuthorizationServiceAuthorization` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::BetaAuthorizationServiceAuthorization`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'project_organization_id')
        self.project_organization_id = attributes[:'project_organization_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          project_organization_id == o.project_organization_id &&
    ...
    def hash
      [id, project_id, project_name, project_organization_id, project_grant_id, granted_organization_id, organization_id, creation_date, change_date, state, user, roles].hash
    end
