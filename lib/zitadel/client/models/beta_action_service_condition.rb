...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaActionServiceCondition.
    class BetaActionServiceCondition < Dry::Struct
      ...
      # @example null
      attribute :function, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :request, Types::Any.optional.meta(omittable: true)
      # @example null
