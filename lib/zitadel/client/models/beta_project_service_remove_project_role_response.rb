...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaProjectServiceRemoveProjectRoleResponse.
    class BetaProjectServiceRemoveProjectRoleResponse < Dry::Struct
      ...
      # @example null
      attribute :removal_date, Types::Any.optional.meta(omittable: true)
    end
  end
end
