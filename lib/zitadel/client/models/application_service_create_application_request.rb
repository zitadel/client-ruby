...
module Zitadel::Client::Models
    ...
    attr_accessor :saml_configuration
    ...
    def self.openapi_types
      {
        ...
        :'name' => :'String',
        :'api_configuration' => :'ApplicationServiceCreateAPIApplicationRequest',
        :'oidc_configuration' => :'ApplicationServiceCreateOIDCApplicationRequest',
        :'saml_configuration' => :'ApplicationServiceCreateSAMLApplicationRequest'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::ApplicationServiceCreateApplicationRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::ApplicationServiceCreateApplicationRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'saml_configuration')
        self.saml_configuration = attributes[:'saml_configuration']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          saml_configuration == o.saml_configuration
    end
    ...
    def hash
      [project_id, application_id, name, api_configuration, oidc_configuration, saml_configuration].hash
    end
