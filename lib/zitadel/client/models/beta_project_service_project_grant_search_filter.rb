...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaProjectServiceProjectGrantSearchFilter.
    class BetaProjectServiceProjectGrantSearchFilter < Dry::Struct
      ...
      # @example null
      attribute :role_key_filter, Types::Any.optional.meta(omittable: true)
    end
  end
end
