...
module Zitadel::Client::Models
    ...
    attr_accessor :device_authorization_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::OIDCServiceAuthorizeOrDenyDeviceAuthorizationRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::OIDCServiceAuthorizeOrDenyDeviceAuthorizationRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'device_authorization_id')
        self.device_authorization_id = attributes[:'device_authorization_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          device_authorization_id == o.device_authorization_id &&
          deny == o.deny &&
          session == o.session
    end
    ...
    def hash
      [device_authorization_id, deny, session].hash
    end
