...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaOrganizationServiceGenerateOrganizationDomainValidationResponse.
    class BetaOrganizationServiceGenerateOrganizationDomainValidationResponse < Dry::Struct
