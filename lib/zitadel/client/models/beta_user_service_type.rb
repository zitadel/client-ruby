...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaUserServiceType.
    class BetaUserServiceType
      ...
      VALUES = [TYPE_UNSPECIFIED, TYPE_HUMAN, TYPE_MACHINE].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaUserServiceType: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
