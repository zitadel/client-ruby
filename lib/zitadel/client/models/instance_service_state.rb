...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for InstanceServiceState.
    class InstanceServiceState
      ...
      VALUES = [STATE_UNSPECIFIED, STATE_CREATING, STATE_RUNNING, STATE_STOPPING, STATE_STOPPED].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for InstanceServiceState: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
