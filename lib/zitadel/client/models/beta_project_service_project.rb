...
module Zitadel::Client::Models
    ...
    def self.openapi_types
      {
        ...
        :'granted_state' => :'BetaProjectServiceGrantedProjectState'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::BetaProjectServiceProject` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::BetaProjectServiceProject`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [id, organization_id, creation_date, change_date, name, state, project_role_assertion, authorization_required, project_access_required, private_labeling_setting, granted_organization_id, granted_organization_name, granted_state].hash
    end
