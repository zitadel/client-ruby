...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for WebKeyServiceRSABits.
    class WebKeyServiceRSABits
      ...
      VALUES = [RSA_BITS_UNSPECIFIED, RSA_BITS_2048, RSA_BITS_3072, RSA_BITS_4096].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for WebKeyServiceRSABits: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
