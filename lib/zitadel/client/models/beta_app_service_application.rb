...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaAppServiceApplication.
    class BetaAppServiceApplication < Dry::Struct
      ...
      # @example null
      attribute :api_config, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :oidc_config, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :saml_config, Types::Any.optional.meta(omittable: true)
    end
  end
end
