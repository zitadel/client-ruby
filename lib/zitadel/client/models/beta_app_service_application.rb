...
module Zitadel::Client::Models
        class BetaAppServiceApplication
    attr_accessor :id
    ...
    def self.openapi_types
      {
        ...
        :'name' => :'String',
        :'api_config' => :'BetaAppServiceAPIConfig',
        :'oidc_config' => :'BetaAppServiceOIDCConfig',
        :'saml_config' => :'BetaAppServiceSAMLConfig'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::BetaAppServiceApplication` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::BetaAppServiceApplication`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'api_config')
        self.api_config = attributes[:'api_config']
      end
      ...
      if attributes.key?(:'saml_config')
        self.saml_config = attributes[:'saml_config']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          state == o.state &&
          name == o.name &&
          api_config == o.api_config &&
          oidc_config == o.oidc_config &&
          saml_config == o.saml_config
    end
    ...
    def hash
      [id, creation_date, change_date, state, name, api_config, oidc_config, saml_config].hash
    end
