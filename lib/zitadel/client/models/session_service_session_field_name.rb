...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for SessionServiceSessionFieldName.
    class SessionServiceSessionFieldName
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for SessionServiceSessionFieldName: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
