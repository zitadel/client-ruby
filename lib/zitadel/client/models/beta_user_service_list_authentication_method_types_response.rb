...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaUserServiceListAuthenticationMethodTypesResponse.
    class BetaUserServiceListAuthenticationMethodTypesResponse < Dry::Struct
      ...
      # @example null
      attribute :auth_method_types, Types::Any.optional.meta(omittable: true)
    end
  end
end
