...
module Zitadel::Client
  ...
  module Models
    # Model class for UserServiceListAuthenticationFactorsRequest.
    class UserServiceListAuthenticationFactorsRequest < Dry::Struct
      ...
      # @example null
      attribute :auth_factors, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :states, Types::Any.optional.meta(omittable: true)
    end
  end
end
