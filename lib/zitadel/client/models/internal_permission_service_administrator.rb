...
module Zitadel::Client
  ...
  module Models
    # Model class for InternalPermissionServiceAdministrator.
    class InternalPermissionServiceAdministrator < Dry::Struct
      ...
      # @example null
      attribute :project, Types::Any.optional.meta(omittable: true)
      # @example null
