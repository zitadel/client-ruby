...
module Zitadel::Client
  ...
  module Models
    # Model class for OrganizationServiceMetadataSearchFilter.
    class OrganizationServiceMetadataSearchFilter < Dry::Struct
      ...
      # @example null
      attribute :key_filter, Types::Any.optional.meta(omittable: true)
    end
  end
end
