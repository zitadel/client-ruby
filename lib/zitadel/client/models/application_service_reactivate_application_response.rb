...
module Zitadel::Client
  ...
  module Models
    # Model class for ApplicationServiceReactivateApplicationResponse.
    class ApplicationServiceReactivateApplicationResponse < Dry::Struct
      ...
      # @example null
      attribute :reactivation_date, Types::Any.optional.meta(omittable: true)
    end
  end
end
