...
module Zitadel::Client::Models
        class BetaAppServiceReactivateApplicationResponse
    ...
    attr_accessor :reactivation_date
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::BetaAppServiceReactivateApplicationResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::BetaAppServiceReactivateApplicationResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'reactivation_date')
        self.reactivation_date = attributes[:'reactivation_date']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          reactivation_date == o.reactivation_date
    end
