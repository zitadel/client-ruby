...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for ApplicationServiceOIDCGrantType.
    class ApplicationServiceOIDCGrantType
      ...
      VALUES = [OIDC_GRANT_TYPE_AUTHORIZATION_CODE, OIDC_GRANT_TYPE_IMPLICIT, OIDC_GRANT_TYPE_REFRESH_TOKEN, OIDC_GRANT_TYPE_DEVICE_CODE, OIDC_GRANT_TYPE_TOKEN_EXCHANGE].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for ApplicationServiceOIDCGrantType: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
