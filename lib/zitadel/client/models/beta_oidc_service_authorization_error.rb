...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaOIDCServiceAuthorizationError.
    class BetaOIDCServiceAuthorizationError < Dry::Struct
      ...
      # @example null
      attribute :error_description, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :error_uri, Types::Any.optional.meta(omittable: true)
    end
  end
end
