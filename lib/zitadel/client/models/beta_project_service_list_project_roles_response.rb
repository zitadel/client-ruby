...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaProjectServiceListProjectRolesResponse.
    class BetaProjectServiceListProjectRolesResponse < Dry::Struct
      ...
      # @example null
      attribute :project_roles, Types::Any.optional.meta(omittable: true)
    end
  end
end
