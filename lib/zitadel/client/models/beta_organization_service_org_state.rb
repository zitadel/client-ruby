...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaOrganizationServiceOrgState.
    class BetaOrganizationServiceOrgState
      ...
      VALUES = [ORG_STATE_UNSPECIFIED, ORG_STATE_ACTIVE, ORG_STATE_INACTIVE, ORG_STATE_REMOVED].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaOrganizationServiceOrgState: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
