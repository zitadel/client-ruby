...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaFeatureServiceSource.
    class BetaFeatureServiceSource
      ...
      VALUES = [SOURCE_UNSPECIFIED, SOURCE_SYSTEM, SOURCE_INSTANCE, SOURCE_ORGANIZATION, SOURCE_PROJECT, SOURCE_APP, SOURCE_USER].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaFeatureServiceSource: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
