...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for AuthorizationServiceState.
    class AuthorizationServiceState
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for AuthorizationServiceState: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
