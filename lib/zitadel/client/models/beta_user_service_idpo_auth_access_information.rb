...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaUserServiceIDPOAuthAccessInformation.
    class BetaUserServiceIDPOAuthAccessInformation < Dry::Struct
      ...
      # @example null
      attribute :access_token, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :id_token, Types::Any.optional.meta(omittable: true)
    end
  end
end
