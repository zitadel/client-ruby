...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaOrganizationServiceSetOrganizationMetadataResponse.
    class BetaOrganizationServiceSetOrganizationMetadataResponse < Dry::Struct
      ...
      # @example null
      attribute :set_date, Types::Any.optional.meta(omittable: true)
    end
  end
end
