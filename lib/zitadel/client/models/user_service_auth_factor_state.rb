...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for UserServiceAuthFactorState.
    class UserServiceAuthFactorState
      ...
      VALUES = [AUTH_FACTOR_STATE_UNSPECIFIED, AUTH_FACTOR_STATE_NOT_READY, AUTH_FACTOR_STATE_READY, AUTH_FACTOR_STATE_REMOVED].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for UserServiceAuthFactorState: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
