...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for InstanceServiceDomainFieldName.
    class InstanceServiceDomainFieldName
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for InstanceServiceDomainFieldName: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
