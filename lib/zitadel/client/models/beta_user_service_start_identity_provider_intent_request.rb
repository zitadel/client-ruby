...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaUserServiceStartIdentityProviderIntentRequest.
    class BetaUserServiceStartIdentityProviderIntentRequest < Dry::Struct
      ...
      # @example null
      attribute :urls, Types::Any.optional.meta(omittable: true)
    end
  end
end
