...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaAuthorizationServiceState.
    class BetaAuthorizationServiceState
      STATE_UNSPECIFIED = 'STATE_UNSPECIFIED'
      STATE_ACTIVE = 'STATE_ACTIVE'
      STATE_INACTIVE = 'STATE_INACTIVE'

      # Frozen set of all allowed values, used for validation.
      VALUES = [STATE_UNSPECIFIED, STATE_ACTIVE, STATE_INACTIVE].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaAuthorizationServiceState: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
