...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaOrganizationServiceSetHumanEmail.
    class BetaOrganizationServiceSetHumanEmail < Dry::Struct
      ...
      # @example null
      attribute :send_code, Types::Any.optional.meta(omittable: true)
    end
  end
end
