...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for ProjectServiceType.
    class ProjectServiceType
      ...
      VALUES = [TYPE_UNSPECIFIED, OWNED, GRANTED, OWNED_OR_GRANTED].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for ProjectServiceType: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
