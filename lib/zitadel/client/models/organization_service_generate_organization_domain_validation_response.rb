...
module Zitadel::Client
  ...
  module Models
    # Model class for OrganizationServiceGenerateOrganizationDomainValidationResponse.
    class OrganizationServiceGenerateOrganizationDomainValidationResponse < Dry::Struct
