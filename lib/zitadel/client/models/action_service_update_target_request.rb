...
module Zitadel::Client
  ...
  module Models
    # Model class for ActionServiceUpdateTargetRequest.
    class ActionServiceUpdateTargetRequest < Dry::Struct
      ...
      # @example null
      attribute :payload_type, Types::Any.optional.meta(omittable: true)
      # @example null
