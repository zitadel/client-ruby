...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaAppServiceCreateApplicationRequest.
    class BetaAppServiceCreateApplicationRequest < Dry::Struct
      ...
      # @example null
      attribute :api_request, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :oidc_request, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :saml_request, Types::Any.optional.meta(omittable: true)
    end
  end
end
