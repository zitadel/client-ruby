...
module Zitadel::Client::Models
        class BetaAppServiceCreateApplicationRequest
    ...
    def self.openapi_types
      {
        ...
        :'id' => :'String',
        :'name' => :'String',
        :'api_request' => :'BetaAppServiceCreateAPIApplicationRequest',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::BetaAppServiceCreateApplicationRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::BetaAppServiceCreateApplicationRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'oidc_request')
        self.oidc_request = attributes[:'oidc_request']
      end
    ...
    def hash
      [project_id, id, name, api_request, oidc_request, saml_request].hash
    end
