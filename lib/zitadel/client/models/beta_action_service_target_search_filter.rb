...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaActionServiceTargetSearchFilter.
    class BetaActionServiceTargetSearchFilter < Dry::Struct
      ...
      # @example null
      attribute :in_target_ids_filter, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :target_name_filter, Types::Any.optional.meta(omittable: true)
    end
  end
end
