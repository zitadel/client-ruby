...
module Zitadel::Client::Models
  class OtpEmail
    ...
    def self.openapi_types
      {
        :'otp_email' => :'UserServiceAuthFactorOTPEmail'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::OtpEmail` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::OtpEmail`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @otp_email.nil?
        invalid_properties.push('invalid value for "otp_email", otp_email cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @otp_email.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [UserServiceAuthFactorOTPEmail] otp_email Value to be assigned
    def otp_email=(otp_email)
      if otp_email.nil?
        fail ArgumentError, 'otp_email cannot be nil'
      end
