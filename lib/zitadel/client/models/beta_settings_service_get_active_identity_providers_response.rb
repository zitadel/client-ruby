...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaSettingsServiceGetActiveIdentityProvidersResponse.
    class BetaSettingsServiceGetActiveIdentityProvidersResponse < Dry::Struct
      ...
      # @example null
      attribute :identity_providers, Types::Any.optional.meta(omittable: true)
    end
  end
end
