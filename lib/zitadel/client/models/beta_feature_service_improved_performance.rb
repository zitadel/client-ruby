...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaFeatureServiceImprovedPerformance.
    class BetaFeatureServiceImprovedPerformance
      ...
      VALUES = [IMPROVED_PERFORMANCE_UNSPECIFIED, IMPROVED_PERFORMANCE_PROJECT_GRANT, IMPROVED_PERFORMANCE_PROJECT, IMPROVED_PERFORMANCE_USER_GRANT, IMPROVED_PERFORMANCE_ORG_DOMAIN_VERIFIED].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaFeatureServiceImprovedPerformance: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
