...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for SettingsServiceAutoLinkingOption.
    class SettingsServiceAutoLinkingOption
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for SettingsServiceAutoLinkingOption: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
