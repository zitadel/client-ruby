...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaUserServiceAddIDPLinkRequest.
    class BetaUserServiceAddIDPLinkRequest < Dry::Struct
      ...
      # @example null
      attribute :idp_link, Types::Any.optional.meta(omittable: true)
    end
  end
end
