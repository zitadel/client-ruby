...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for FeatureServiceImprovedPerformance.
    class FeatureServiceImprovedPerformance
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for FeatureServiceImprovedPerformance: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
