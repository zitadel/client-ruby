...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaProjectServiceProjectState.
    class BetaProjectServiceProjectState
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaProjectServiceProjectState: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
