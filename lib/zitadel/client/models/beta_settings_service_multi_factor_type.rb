...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaSettingsServiceMultiFactorType.
    class BetaSettingsServiceMultiFactorType
      ...
      VALUES = [MULTI_FACTOR_TYPE_UNSPECIFIED, MULTI_FACTOR_TYPE_U2_F_WITH_VERIFICATION].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaSettingsServiceMultiFactorType: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
