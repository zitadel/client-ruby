...
module Zitadel::Client
  ...
  module Models
    # Model class for OIDCServiceGetDeviceAuthorizationRequestResponse.
    class OIDCServiceGetDeviceAuthorizationRequestResponse < Dry::Struct
      ...
      # @example null
      attribute :device_authorization_request, Types::Any.optional.meta(omittable: true)
    end
  end
end
