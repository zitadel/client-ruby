...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaActionServiceInTargetIDsFilter.
    class BetaActionServiceInTargetIDsFilter < Dry::Struct
      ...
      # @example null
      attribute :target_ids, Types::Any.optional.meta(omittable: true)
    end
  end
end
