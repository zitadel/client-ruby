...
module Zitadel::Client::Models
    ...
    attr_accessor :in_user_ids_filter
    ...
    attr_accessor :user_organization_id

    attr_accessor :user_preferred_login_name
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::BetaInternalPermissionServiceAdministratorSearchFilter` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::BetaInternalPermissionServiceAdministratorSearchFilter`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          user_preferred_login_name == o.user_preferred_login_name
    end
    ...
    def hash
      [_and, change_date, creation_date, in_user_ids_filter, _not, _or, resource, role, user_display_name, user_organization_id, user_preferred_login_name].hash
    end
