...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaAppServiceOIDCTokenType.
    class BetaAppServiceOIDCTokenType
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaAppServiceOIDCTokenType: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
