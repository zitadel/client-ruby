  ...
  class OrganizationIdQuery1
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::OrganizationIdQuery1` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::OrganizationIdQuery1`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'organization_id_query')
        ...
        self.organization_id_query = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @organization_id_query.nil?
        invalid_properties.push('invalid value for "organization_id_query", organization_id_query cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @organization_id_query.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [BetaUserServiceOrganizationIdQuery] organization_id_query Value to be assigned
    def organization_id_query=(organization_id_query)
      if organization_id_query.nil?
        fail ArgumentError, 'organization_id_query cannot be nil'
      end

      @organization_id_query = organization_id_query
    end
