...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaWebKeyServiceRSA.
    class BetaWebKeyServiceRSA < Dry::Struct
      ...
      # @example null
      attribute :bits, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :hasher, Types::Any.optional.meta(omittable: true)
    end
  end
end
