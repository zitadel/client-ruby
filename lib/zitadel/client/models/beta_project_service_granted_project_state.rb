...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaProjectServiceGrantedProjectState.
    class BetaProjectServiceGrantedProjectState
      ...
      VALUES = [GRANTED_PROJECT_STATE_UNSPECIFIED, GRANTED_PROJECT_STATE_ACTIVE, GRANTED_PROJECT_STATE_INACTIVE].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaProjectServiceGrantedProjectState: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
