  ...
  class OrgDomain
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::OrgDomain` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::OrgDomain`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @org_domain.nil?
        invalid_properties.push('invalid value for "org_domain", org_domain cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @org_domain.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [String] org_domain Value to be assigned
    def org_domain=(org_domain)
      if org_domain.nil?
        fail ArgumentError, 'org_domain cannot be nil'
      end
