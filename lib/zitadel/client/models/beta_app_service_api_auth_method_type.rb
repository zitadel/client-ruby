...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaAppServiceAPIAuthMethodType.
    class BetaAppServiceAPIAuthMethodType
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaAppServiceAPIAuthMethodType: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
