...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for SettingsServiceIdentityProviderType.
    class SettingsServiceIdentityProviderType
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for SettingsServiceIdentityProviderType: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
