...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for InstanceServiceTextQueryMethod.
    class InstanceServiceTextQueryMethod
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for InstanceServiceTextQueryMethod: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
