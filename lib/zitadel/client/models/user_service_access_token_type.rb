...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for UserServiceAccessTokenType.
    class UserServiceAccessTokenType
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for UserServiceAccessTokenType: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
