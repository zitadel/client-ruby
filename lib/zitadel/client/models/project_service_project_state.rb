...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for ProjectServiceProjectState.
    class ProjectServiceProjectState
      ...
      VALUES = [PROJECT_STATE_UNSPECIFIED, PROJECT_STATE_ACTIVE, PROJECT_STATE_INACTIVE].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for ProjectServiceProjectState: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
