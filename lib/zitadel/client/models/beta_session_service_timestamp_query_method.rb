...
module Zitadel::Client::Models
    ...
    def build_from_hash(value)
      return value if BetaSessionServiceTimestampQueryMethod.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #Zitadel::Client::Models::BetaSessionServiceTimestampQueryMethod"
    end
  end
