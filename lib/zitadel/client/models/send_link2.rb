...
module Zitadel::Client::Models
  class SendLink2
    ...
    def self.openapi_types
      {
        :'send_link' => :'BetaUserServiceSendPasskeyRegistrationLink'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::SendLink2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::SendLink2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @send_link.nil?
        invalid_properties.push('invalid value for "send_link", send_link cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @send_link.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [BetaUserServiceSendPasskeyRegistrationLink] send_link Value to be assigned
    def send_link=(send_link)
      if send_link.nil?
        fail ArgumentError, 'send_link cannot be nil'
      end
