...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaAppServiceOIDCVersion.
    class BetaAppServiceOIDCVersion
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaAppServiceOIDCVersion: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
