...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for UserServiceUserFieldName.
    class UserServiceUserFieldName
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for UserServiceUserFieldName: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
