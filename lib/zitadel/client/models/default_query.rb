...
module Zitadel::Client::Models
  class DefaultQuery
    ...
    def self.openapi_types
      {
        :'default_query' => :'OrganizationServiceDefaultOrganizationQuery'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::DefaultQuery` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::DefaultQuery`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @default_query.nil?
        invalid_properties.push('invalid value for "default_query", default_query cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @default_query.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [OrganizationServiceDefaultOrganizationQuery] default_query Value to be assigned
    def default_query=(default_query)
      if default_query.nil?
        fail ArgumentError, 'default_query cannot be nil'
      end
