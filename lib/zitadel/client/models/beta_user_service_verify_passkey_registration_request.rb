...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaUserServiceVerifyPasskeyRegistrationRequest.
    class BetaUserServiceVerifyPasskeyRegistrationRequest < Dry::Struct
      ...
      # @example null
      attribute :passkey_name, Types::Any.optional.meta(omittable: true)
    end
  end
end
