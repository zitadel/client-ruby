...
module Zitadel::Client::Models
  class BetaUserServiceVerifyPasskeyRegistrationRequest
    ...
    def self.openapi_types
      {
        :'user_id' => :'String',
        :'passkey_id' => :'String',
        :'public_key_credential' => :'Hash<String, BetaUserServiceValue>',
        :'passkey_name' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::BetaUserServiceVerifyPasskeyRegistrationRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::BetaUserServiceVerifyPasskeyRegistrationRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @passkey_id.nil?
        invalid_properties.push('invalid value for "passkey_id", passkey_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @passkey_id.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Hash<String, BetaUserServiceValue>] public_key_credential Value to be assigned
    ...
    def hash
      [user_id, passkey_id, public_key_credential, passkey_name].hash
    end
