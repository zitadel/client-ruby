...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaActionServiceListExecutionMethodsResponse.
    class BetaActionServiceListExecutionMethodsResponse < Dry::Struct
      ...
      # @example null
      attribute :methods, Types::Any.optional.meta(omittable: true)
    end
  end
end
