...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaWebKeyServiceECDSACurve.
    class BetaWebKeyServiceECDSACurve
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaWebKeyServiceECDSACurve: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
