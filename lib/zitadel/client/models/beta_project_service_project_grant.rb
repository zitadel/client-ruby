...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaProjectServiceProjectGrant.
    class BetaProjectServiceProjectGrant < Dry::Struct
      ...
      # @example null
      attribute :granted_organization_name, Types::Any.optional.meta(omittable: true)
      # The roles of the granted project.
      # @example null
      attribute :granted_role_keys, Types::Any.optional.meta(omittable: true)
