...
module Zitadel::Client::Models
        class BetaProjectServiceProjectGrant
    ...
    attr_accessor :granted_organization_id

    # The name of the organization the project is granted to.
    attr_accessor :granted_organization_name

    # The roles of the granted project.
    attr_accessor :granted_role_keys
    ...
    def self.attribute_map
      {
        ...
        :'granted_role_keys' => :'grantedRoleKeys',
    ...
    def self.openapi_types
      {
        ...
        :'granted_role_keys' => :'Array<String>',
        :'project_id' => :'String',
        :'project_name' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::BetaProjectServiceProjectGrant` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::BetaProjectServiceProjectGrant`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'granted_role_keys')
        if (value = attributes[:'granted_role_keys']).is_a?(Array)
          self.granted_role_keys = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          granted_role_keys == o.granted_role_keys &&
    ...
    def hash
      [organization_id, creation_date, change_date, granted_organization_id, granted_organization_name, granted_role_keys, project_id, project_name, state].hash
    end
