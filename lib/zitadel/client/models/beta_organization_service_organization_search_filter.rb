...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaOrganizationServiceOrganizationSearchFilter.
    class BetaOrganizationServiceOrganizationSearchFilter < Dry::Struct
      ...
      # @example null
      attribute :id_filter, Types::Any.optional.meta(omittable: true)
      # @example null
