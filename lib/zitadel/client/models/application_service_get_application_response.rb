...
module Zitadel::Client
  ...
  module Models
    # Model class for ApplicationServiceGetApplicationResponse.
    class ApplicationServiceGetApplicationResponse < Dry::Struct
      ...
      # @example null
      attribute :application, Types::Any.optional.meta(omittable: true)
    end
  end
end
