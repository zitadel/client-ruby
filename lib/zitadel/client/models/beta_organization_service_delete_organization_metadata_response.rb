...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaOrganizationServiceDeleteOrganizationMetadataResponse.
    class BetaOrganizationServiceDeleteOrganizationMetadataResponse < Dry::Struct
      ...
      # @example null
      attribute :deletion_date, Types::Any.optional.meta(omittable: true)
    end
  end
end
