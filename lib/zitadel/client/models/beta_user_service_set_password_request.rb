...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaUserServiceSetPasswordRequest.
    class BetaUserServiceSetPasswordRequest < Dry::Struct
      ...
      # @example null
      attribute :new_password, Types::Any.optional.meta(omittable: true)
      # @example null
