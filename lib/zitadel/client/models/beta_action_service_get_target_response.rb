...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaActionServiceGetTargetResponse.
    class BetaActionServiceGetTargetResponse < Dry::Struct
      ...
      # @example null
      attribute :target, Types::Any.optional.meta(omittable: true)
    end
  end
end
