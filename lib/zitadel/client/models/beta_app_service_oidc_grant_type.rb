...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaAppServiceOIDCGrantType.
    class BetaAppServiceOIDCGrantType
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaAppServiceOIDCGrantType: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
