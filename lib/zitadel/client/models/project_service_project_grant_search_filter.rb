...
module Zitadel::Client
  ...
  module Models
    # Model class for ProjectServiceProjectGrantSearchFilter.
    class ProjectServiceProjectGrantSearchFilter < Dry::Struct
      ...
      # @example null
      attribute :granted_organization_id_filter, Types::Any.optional.meta(omittable: true)
      # @example null
