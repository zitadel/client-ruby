...
module Zitadel::Client::Models
  class BetaSettingsServicePasswordExpirySettings
    ...
    attr_accessor :expire_warn_days
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::BetaSettingsServicePasswordExpirySettings` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::BetaSettingsServicePasswordExpirySettings`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'max_age_days')
        self.max_age_days = attributes[:'max_age_days']
      end

      if attributes.key?(:'expire_warn_days')
        self.expire_warn_days = attributes[:'expire_warn_days']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          expire_warn_days == o.expire_warn_days &&
    ...
    def hash
      [max_age_days, expire_warn_days, resource_owner_type].hash
    end
