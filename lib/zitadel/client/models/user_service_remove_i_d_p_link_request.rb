  ...
  class UserServiceRemoveIDPLinkRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::UserServiceRemoveIDPLinkRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::UserServiceRemoveIDPLinkRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @linked_user_id.nil?
        invalid_properties.push('invalid value for "linked_user_id", linked_user_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @linked_user_id.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          user_id == o.user_id &&
          idp_id == o.idp_id &&
          linked_user_id == o.linked_user_id
    end
    ...
    def hash
      [user_id, idp_id, linked_user_id].hash
    end
