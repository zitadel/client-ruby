...
module Zitadel::Client
  ...
  module Models
    # Model class for InstanceServiceCustomDomain.
    class InstanceServiceCustomDomain < Dry::Struct
      ...
      # @example null
      attribute :primary, Types::Any.optional.meta(omittable: true)
      ...
      # @example null
      attribute :generated, Types::Any.optional.meta(omittable: true)
    end
  end
end
