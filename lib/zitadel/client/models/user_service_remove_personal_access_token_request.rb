...
module Zitadel::Client
  ...
  module Models
    # Model class for UserServiceRemovePersonalAccessTokenRequest.
    class UserServiceRemovePersonalAccessTokenRequest < Dry::Struct
      ...
      # The tokens ID.
      # @example null
      attribute :token_id, Types::Any.optional.meta(omittable: true)
    end
  end
end
