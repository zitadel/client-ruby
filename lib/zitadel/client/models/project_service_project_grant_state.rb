...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for ProjectServiceProjectGrantState.
    class ProjectServiceProjectGrantState
      ...
      VALUES = [PROJECT_GRANT_STATE_UNSPECIFIED, PROJECT_GRANT_STATE_ACTIVE, PROJECT_GRANT_STATE_INACTIVE].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for ProjectServiceProjectGrantState: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
