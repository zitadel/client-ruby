...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaOIDCServiceErrorReason.
    class BetaOIDCServiceErrorReason
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaOIDCServiceErrorReason: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
