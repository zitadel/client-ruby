...
module Zitadel::Client::Models
  class UserIdQuery
    ...
    def self.openapi_types
      {
        :'user_id_query' => :'BetaSessionServiceUserIDQuery'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::UserIdQuery` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::UserIdQuery`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @user_id_query.nil?
        invalid_properties.push('invalid value for "user_id_query", user_id_query cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @user_id_query.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [BetaSessionServiceUserIDQuery] user_id_query Value to be assigned
    def user_id_query=(user_id_query)
      if user_id_query.nil?
        fail ArgumentError, 'user_id_query cannot be nil'
      end
