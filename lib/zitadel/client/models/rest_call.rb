  ...
  class RestCall
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::RestCall` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::RestCall`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @rest_call.nil?
        invalid_properties.push('invalid value for "rest_call", rest_call cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @rest_call.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [BetaActionServiceRESTCall] rest_call Value to be assigned
    def rest_call=(rest_call)
      if rest_call.nil?
        fail ArgumentError, 'rest_call cannot be nil'
      end
