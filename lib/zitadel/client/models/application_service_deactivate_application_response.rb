...
module Zitadel::Client
  ...
  module Models
    # Model class for ApplicationServiceDeactivateApplicationResponse.
    class ApplicationServiceDeactivateApplicationResponse < Dry::Struct
      ...
      # @example null
      attribute :deactivation_date, Types::Any.optional.meta(omittable: true)
    end
  end
end
