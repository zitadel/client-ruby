...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaProjectServiceProjectGrantState.
    class BetaProjectServiceProjectGrantState
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaProjectServiceProjectGrantState: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
