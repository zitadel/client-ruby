...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaProjectServiceProjectFieldName.
    class BetaProjectServiceProjectFieldName
      ...
      VALUES = [PROJECT_FIELD_NAME_UNSPECIFIED, PROJECT_FIELD_NAME_ID, PROJECT_FIELD_NAME_CREATION_DATE, PROJECT_FIELD_NAME_CHANGE_DATE, PROJECT_FIELD_NAME_NAME].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaProjectServiceProjectFieldName: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
