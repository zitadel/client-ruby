...
module Zitadel::Client::Models
  class CreationDateQuery
    ...
    def self.openapi_types
      {
        :'creation_date_query' => :'BetaSessionServiceCreationDateQuery'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::CreationDateQuery` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::CreationDateQuery`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @creation_date_query.nil?
        invalid_properties.push('invalid value for "creation_date_query", creation_date_query cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @creation_date_query.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [BetaSessionServiceCreationDateQuery] creation_date_query Value to be assigned
    def creation_date_query=(creation_date_query)
      if creation_date_query.nil?
        fail ArgumentError, 'creation_date_query cannot be nil'
      end

      @creation_date_query = creation_date_query
    end
