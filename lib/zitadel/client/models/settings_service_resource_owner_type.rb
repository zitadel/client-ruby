...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for SettingsServiceResourceOwnerType.
    class SettingsServiceResourceOwnerType
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for SettingsServiceResourceOwnerType: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
