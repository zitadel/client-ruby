...
module Zitadel::Client::Models
  class BetaUserServiceUserFieldName
    ...
    def build_from_hash(value)
      return value if BetaUserServiceUserFieldName.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #Zitadel::Client::Models::BetaUserServiceUserFieldName"
    end
  end
