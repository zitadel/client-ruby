...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaUserServiceUserFieldName.
    class BetaUserServiceUserFieldName
      ...
      VALUES = [USER_FIELD_NAME_UNSPECIFIED, USER_FIELD_NAME_USER_NAME, USER_FIELD_NAME_FIRST_NAME, USER_FIELD_NAME_LAST_NAME, USER_FIELD_NAME_NICK_NAME, USER_FIELD_NAME_DISPLAY_NAME, USER_FIELD_NAME_EMAIL, USER_FIELD_NAME_STATE, USER_FIELD_NAME_TYPE, USER_FIELD_NAME_CREATION_DATE].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaUserServiceUserFieldName: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
