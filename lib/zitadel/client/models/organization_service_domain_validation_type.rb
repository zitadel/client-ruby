...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for OrganizationServiceDomainValidationType.
    class OrganizationServiceDomainValidationType
      ...
      VALUES = [DOMAIN_VALIDATION_TYPE_UNSPECIFIED, DOMAIN_VALIDATION_TYPE_HTTP, DOMAIN_VALIDATION_TYPE_DNS].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for OrganizationServiceDomainValidationType: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
