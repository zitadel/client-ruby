...
module Zitadel::Client::Models
    ...
    def self.openapi_types
      {
        ...
        :'project_grants' => :'Array<BetaProjectServiceProjectGrant>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::BetaProjectServiceListProjectGrantsResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::BetaProjectServiceListProjectGrantsResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'project_grants')
        if (value = attributes[:'project_grants']).is_a?(Array)
          self.project_grants = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          project_grants == o.project_grants
    end
    ...
    def hash
      [pagination, project_grants].hash
    end
