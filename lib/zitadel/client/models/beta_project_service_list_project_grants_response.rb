...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaProjectServiceListProjectGrantsResponse.
    class BetaProjectServiceListProjectGrantsResponse < Dry::Struct
      ...
      # @example null
      attribute :project_grants, Types::Any.optional.meta(omittable: true)
    end
  end
end
