...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaInstanceServiceFieldName.
    class BetaInstanceServiceFieldName
      ...
      VALUES = [FIELD_NAME_UNSPECIFIED, FIELD_NAME_ID, FIELD_NAME_NAME, FIELD_NAME_CREATION_DATE].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaInstanceServiceFieldName: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
