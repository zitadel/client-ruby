...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for UserServiceByteFilterMethod.
    class UserServiceByteFilterMethod
      ...
      VALUES = [BYTE_FILTER_METHOD_EQUALS, BYTE_FILTER_METHOD_NOT_EQUALS].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for UserServiceByteFilterMethod: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
