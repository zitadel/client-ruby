...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for IdentityProviderServiceAzureADTenantType.
    class IdentityProviderServiceAzureADTenantType
      ...
      VALUES = [AZURE_AD_TENANT_TYPE_COMMON, AZURE_AD_TENANT_TYPE_ORGANISATIONS, AZURE_AD_TENANT_TYPE_CONSUMERS].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for IdentityProviderServiceAzureADTenantType: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
