...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for IdentityProviderServiceSAMLBinding.
    class IdentityProviderServiceSAMLBinding
      ...
      VALUES = [SAML_BINDING_UNSPECIFIED, SAML_BINDING_POST, SAML_BINDING_REDIRECT, SAML_BINDING_ARTIFACT].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for IdentityProviderServiceSAMLBinding: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
