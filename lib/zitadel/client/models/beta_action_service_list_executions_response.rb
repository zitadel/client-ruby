...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaActionServiceListExecutionsResponse.
    class BetaActionServiceListExecutionsResponse < Dry::Struct
      ...
      # @example null
      attribute :executions, Types::Any.optional.meta(omittable: true)
    end
  end
end
