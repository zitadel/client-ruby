...
module Zitadel::Client
  ...
  module Models
    # Model class for OrganizationServiceGenerateOrganizationDomainValidationRequest.
    class OrganizationServiceGenerateOrganizationDomainValidationRequest < Dry::Struct
