...
module Zitadel::Client::Models
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::BetaSettingsServiceLockoutSettings` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::BetaSettingsServiceLockoutSettings`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'max_password_attempts')
        self.max_password_attempts = attributes[:'max_password_attempts']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          max_password_attempts == o.max_password_attempts &&
          resource_owner_type == o.resource_owner_type &&
          max_otp_attempts == o.max_otp_attempts
    end
    ...
    def hash
      [max_password_attempts, resource_owner_type, max_otp_attempts].hash
    end
