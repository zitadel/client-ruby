...
module Zitadel::Client
  ...
  module Models
    # Model class for ApplicationServiceCreateApplicationKeyResponse.
    class ApplicationServiceCreateApplicationKeyResponse < Dry::Struct
      ...
      # @example null
      attribute :key_details, Types::Any.optional.meta(omittable: true)
    end
  end
end
