...
module Zitadel::Client::Models
    ...
    attr_accessor :creation_allowed

    attr_accessor :linking_allowed
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::SettingsServiceGetActiveIdentityProvidersRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::SettingsServiceGetActiveIdentityProvidersRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'creation_allowed')
        self.creation_allowed = attributes[:'creation_allowed']
      end

      if attributes.key?(:'linking_allowed')
        self.linking_allowed = attributes[:'linking_allowed']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ctx == o.ctx &&
          creation_allowed == o.creation_allowed &&
          linking_allowed == o.linking_allowed &&
    ...
    def hash
      [ctx, creation_allowed, linking_allowed, auto_creation, auto_linking].hash
    end
