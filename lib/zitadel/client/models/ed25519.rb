...
module Zitadel::Client::Models
  class Ed25519
    ...
    def self.openapi_types
      {
        :'ed25519' => :'BetaWebKeyServiceED25519'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::Ed25519` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::Ed25519`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @ed25519.nil?
        invalid_properties.push('invalid value for "ed25519", ed25519 cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ed25519.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [BetaWebKeyServiceED25519] ed25519 Value to be assigned
    def ed25519=(ed25519)
      if ed25519.nil?
        fail ArgumentError, 'ed25519 cannot be nil'
      end
