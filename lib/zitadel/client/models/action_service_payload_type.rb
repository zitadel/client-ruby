...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for ActionServicePayloadType.
    class ActionServicePayloadType
      ...
      VALUES = [PAYLOAD_TYPE_UNSPECIFIED, PAYLOAD_TYPE_JSON, PAYLOAD_TYPE_JWT, PAYLOAD_TYPE_JWE].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for ActionServicePayloadType: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
