...
module Zitadel::Client::Models
    ...
    def self.attribute_map
      {
        ...
        :'requires_uppercase' => :'requiresUppercase',
        :'requires_lowercase' => :'requiresLowercase',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::BetaSettingsServicePasswordComplexitySettings` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::BetaSettingsServicePasswordComplexitySettings`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'requires_uppercase')
        self.requires_uppercase = attributes[:'requires_uppercase']
      end

      if attributes.key?(:'requires_lowercase')
        self.requires_lowercase = attributes[:'requires_lowercase']
      end

      if attributes.key?(:'requires_number')
        self.requires_number = attributes[:'requires_number']
      end

      if attributes.key?(:'requires_symbol')
        self.requires_symbol = attributes[:'requires_symbol']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          requires_uppercase == o.requires_uppercase &&
          requires_lowercase == o.requires_lowercase &&
          requires_number == o.requires_number &&
          requires_symbol == o.requires_symbol &&
    ...
    def hash
      [min_length, requires_uppercase, requires_lowercase, requires_number, requires_symbol, resource_owner_type].hash
    end
