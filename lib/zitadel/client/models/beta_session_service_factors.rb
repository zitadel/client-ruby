...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaSessionServiceFactors.
    class BetaSessionServiceFactors < Dry::Struct
      ...
      OPENAPI_TYPES = {
        ...
        web_auth_n: 'BetaSessionServiceWebAuthNFactor',
        intent: 'BetaSessionServiceIntentFactor',
        totp: 'BetaSessionServiceTOTPFactor',
        otp_sms: 'BetaSessionServiceOTPFactor',
        otp_email: 'BetaSessionServiceOTPFactor'
      }.freeze
