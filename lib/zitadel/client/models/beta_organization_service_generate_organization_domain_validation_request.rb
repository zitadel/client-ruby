...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaOrganizationServiceGenerateOrganizationDomainValidationRequest.
    class BetaOrganizationServiceGenerateOrganizationDomainValidationRequest < Dry::Struct
