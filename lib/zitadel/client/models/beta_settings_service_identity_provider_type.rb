...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaSettingsServiceIdentityProviderType.
    class BetaSettingsServiceIdentityProviderType
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaSettingsServiceIdentityProviderType: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
