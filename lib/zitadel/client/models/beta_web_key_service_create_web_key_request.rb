...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaWebKeyServiceCreateWebKeyRequest.
    class BetaWebKeyServiceCreateWebKeyRequest < Dry::Struct
      ...
      # @example null
      attribute :ecdsa, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :ed25519, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :rsa, Types::Any.optional.meta(omittable: true)
    end
  end
end
