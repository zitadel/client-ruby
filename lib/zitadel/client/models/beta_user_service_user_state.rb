...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaUserServiceUserState.
    class BetaUserServiceUserState
      ...
      VALUES = [USER_STATE_UNSPECIFIED, USER_STATE_ACTIVE, USER_STATE_INACTIVE, USER_STATE_DELETED, USER_STATE_LOCKED, USER_STATE_INITIAL].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaUserServiceUserState: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
