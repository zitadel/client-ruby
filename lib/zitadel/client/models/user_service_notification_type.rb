...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for UserServiceNotificationType.
    class UserServiceNotificationType
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for UserServiceNotificationType: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
