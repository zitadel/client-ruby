...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaUserServiceUpdateHumanUserResponse.
    class BetaUserServiceUpdateHumanUserResponse < Dry::Struct
      ...
      # @example null
      attribute :email_code, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :phone_code, Types::Any.optional.meta(omittable: true)
    end
  end
end
