...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for BetaSessionServiceSessionFieldName.
    class BetaSessionServiceSessionFieldName
      ...
      VALUES = [SESSION_FIELD_NAME_UNSPECIFIED, SESSION_FIELD_NAME_CREATION_DATE].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for BetaSessionServiceSessionFieldName: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
