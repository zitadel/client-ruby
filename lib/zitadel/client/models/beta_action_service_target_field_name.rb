...
module Zitadel::Client::Models
  class BetaActionServiceTargetFieldName
    ...
    def build_from_hash(value)
      return value if BetaActionServiceTargetFieldName.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #Zitadel::Client::Models::BetaActionServiceTargetFieldName"
    end
  end
