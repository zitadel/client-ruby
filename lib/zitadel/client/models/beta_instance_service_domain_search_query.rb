...
module Zitadel::Client::Models
    ...
    def self.openapi_types
      {
        :'domain_query' => :'BetaInstanceServiceDomainQuery',
        :'generated_query' => :'BetaInstanceServiceDomainGeneratedQuery',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::BetaInstanceServiceDomainSearchQuery` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::BetaInstanceServiceDomainSearchQuery`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'generated_query')
        self.generated_query = attributes[:'generated_query']
      end

      if attributes.key?(:'primary_query')
        self.primary_query = attributes[:'primary_query']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          generated_query == o.generated_query &&
          primary_query == o.primary_query
    end
    ...
    def hash
      [domain_query, generated_query, primary_query].hash
    end
