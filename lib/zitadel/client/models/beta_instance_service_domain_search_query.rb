...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaInstanceServiceDomainSearchQuery.
    class BetaInstanceServiceDomainSearchQuery < Dry::Struct
      ...
      # @example null
      attribute :generated_query, Types::Any.optional.meta(omittable: true)
      # @example null
      attribute :primary_query, Types::Any.optional.meta(omittable: true)
    end
  end
end
