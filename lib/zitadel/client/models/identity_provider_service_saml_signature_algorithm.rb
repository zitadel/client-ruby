...
module Zitadel::Client
  ...
  module Models
    # Enumeration of allowed values for IdentityProviderServiceSAMLSignatureAlgorithm.
    class IdentityProviderServiceSAMLSignatureAlgorithm
      ...
      VALUES = [SAML_SIGNATURE_UNSPECIFIED, SAML_SIGNATURE_RSA_SHA1, SAML_SIGNATURE_RSA_SHA256, SAML_SIGNATURE_RSA_SHA512].freeze
      ...
      def self.validate!(value)
        ...
        raise ArgumentError, "Unknown enum value for IdentityProviderServiceSAMLSignatureAlgorithm: #{value.inspect} (allowed: #{VALUES.inspect})"
      end
    end
  end
end
