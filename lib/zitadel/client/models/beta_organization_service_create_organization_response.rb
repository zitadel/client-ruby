...
module Zitadel::Client::Models
        class BetaOrganizationServiceCreateOrganizationResponse
    ...
    attr_accessor :organization_admins
    ...
    def self.openapi_types
      {
        :'creation_date' => :'Time',
        :'id' => :'String',
        :'organization_admins' => :'Array<BetaOrganizationServiceOrganizationAdmin>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zitadel::Client::Models::BetaOrganizationServiceCreateOrganizationResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zitadel::Client::Models::BetaOrganizationServiceCreateOrganizationResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'organization_admins')
        if (value = attributes[:'organization_admins']).is_a?(Array)
          self.organization_admins = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          id == o.id &&
          organization_admins == o.organization_admins
    end
    ...
    def hash
      [creation_date, id, organization_admins].hash
    end
