...
module Zitadel::Client
  ...
  module Models
    # Model class for BetaOrganizationServiceCreateOrganizationResponse.
    class BetaOrganizationServiceCreateOrganizationResponse < Dry::Struct
      ...
      # @example null
      attribute :organization_admins, Types::Any.optional.meta(omittable: true)
    end
  end
end
