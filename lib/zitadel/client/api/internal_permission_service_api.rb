  ...
  module Api
    ...
    class InternalPermissionServiceApi < BaseApi
      ...
      def create_administrator_with_http_info(internal_permission_service_create_administrator_request)
        ...
        request_body = ::Zitadel::Client::ObjectSerializer.encode_oneof_body(internal_permission_service_create_administrator_request, 'InternalPermissionServiceCreateAdministratorRequest')
      ...
      def delete_administrator_with_http_info(internal_permission_service_delete_administrator_request)
        ...
        # (primitives, plain models) and for discriminated / model-ref unions,
        # whose resolved value already serializes correctly.
        request_body = ::Zitadel::Client::ObjectSerializer.encode_oneof_body(internal_permission_service_delete_administrator_request, 'InternalPermissionServiceDeleteAdministratorRequest')
        invoke_api_for_result(
          :POST, path, query_params, header_params, request_body,
          ['application/json'],
          'application/json',
      ...
      def list_administrators_with_http_info(internal_permission_service_list_administrators_request)
        ...
        # (primitives, plain models) and for discriminated / model-ref unions,
        # whose resolved value already serializes correctly.
        request_body = ::Zitadel::Client::ObjectSerializer.encode_oneof_body(internal_permission_service_list_administrators_request, 'InternalPermissionServiceListAdministratorsRequest')
        invoke_api_for_result(
          :POST, path, query_params, header_params, request_body,
          ['application/json'],
          'application/json',
      ...
      def update_administrator_with_http_info(internal_permission_service_update_administrator_request)
        ...
        # (primitives, plain models) and for discriminated / model-ref unions,
        # whose resolved value already serializes correctly.
        request_body = ::Zitadel::Client::ObjectSerializer.encode_oneof_body(internal_permission_service_update_administrator_request, 'InternalPermissionServiceUpdateAdministratorRequest')
        invoke_api_for_result(
          :POST, path, query_params, header_params, request_body,
          ['application/json'],
          'application/json',
