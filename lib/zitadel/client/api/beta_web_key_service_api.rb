...
module Zitadel::Client
  module Api
    ...
    class BetaWebKeyServiceApi < BaseApi
      ...
      def activate_web_key(beta_web_key_service_activate_web_key_request)
        if beta_web_key_service_activate_web_key_request.nil?
          raise ArgumentError,
                "Missing the required parameter 'beta_web_key_service_activate_web_key_request' when calling BetaWebKeyServiceApi.activate_web_key"
        end

        result = activate_web_key_with_http_info(beta_web_key_service_activate_web_key_request)
      ...
      # @return [ApiResult]
      # @raise [ApiError] if fails to make API call
      def activate_web_key_with_http_info(beta_web_key_service_activate_web_key_request)
        if beta_web_key_service_activate_web_key_request.nil?
          raise ArgumentError,
                "Missing the required parameter 'beta_web_key_service_activate_web_key_request' when calling BetaWebKeyServiceApi.activate_web_key"
        end
        ...
        request_body = ::Zitadel::Client::ObjectSerializer.encode_oneof_body(beta_web_key_service_activate_web_key_request, 'BetaWebKeyServiceActivateWebKeyRequest')
      ...
      # @raise [ApiError] if fails to make API call
      def create_web_key(beta_web_key_service_create_web_key_request)
        if beta_web_key_service_create_web_key_request.nil?
          raise ArgumentError,
                "Missing the required parameter 'beta_web_key_service_create_web_key_request' when calling BetaWebKeyServiceApi.create_web_key"
        end

        result = create_web_key_with_http_info(beta_web_key_service_create_web_key_request)
        # This operation declares a non-void return type. When the server
        # responds with an empty/undecodable body (204, empty 200), the
        # unwrapped convenience method has no value to return. Surface this
        # loudly as a typed ApiError instead of handing back a silent nil,
      ...
      # @return [ApiResult]
      # @raise [ApiError] if fails to make API call
      def create_web_key_with_http_info(beta_web_key_service_create_web_key_request)
        if beta_web_key_service_create_web_key_request.nil?
          raise ArgumentError,
                "Missing the required parameter 'beta_web_key_service_create_web_key_request' when calling BetaWebKeyServiceApi.create_web_key"
        end
        ...
        # (primitives, plain models) and for discriminated / model-ref unions,
        # whose resolved value already serializes correctly.
        request_body = ::Zitadel::Client::ObjectSerializer.encode_oneof_body(beta_web_key_service_create_web_key_request, 'BetaWebKeyServiceCreateWebKeyRequest')
        invoke_api_for_result(
          :POST, path, query_params, header_params, request_body,
          ['application/json'],
          'application/json',
      ...
      # @raise [ApiError] if fails to make API call
      def delete_web_key(beta_web_key_service_delete_web_key_request)
        if beta_web_key_service_delete_web_key_request.nil?
          raise ArgumentError,
                "Missing the required parameter 'beta_web_key_service_delete_web_key_request' when calling BetaWebKeyServiceApi.delete_web_key"
        end

        result = delete_web_key_with_http_info(beta_web_key_service_delete_web_key_request)
        # This operation declares a non-void return type. When the server
        # responds with an empty/undecodable body (204, empty 200), the
        # unwrapped convenience method has no value to return. Surface this
        # loudly as a typed ApiError instead of handing back a silent nil,
      ...
      # @return [ApiResult]
      # @raise [ApiError] if fails to make API call
      def delete_web_key_with_http_info(beta_web_key_service_delete_web_key_request)
        if beta_web_key_service_delete_web_key_request.nil?
          raise ArgumentError,
                "Missing the required parameter 'beta_web_key_service_delete_web_key_request' when calling BetaWebKeyServiceApi.delete_web_key"
        end
        ...
        # (primitives, plain models) and for discriminated / model-ref unions,
        # whose resolved value already serializes correctly.
        request_body = ::Zitadel::Client::ObjectSerializer.encode_oneof_body(beta_web_key_service_delete_web_key_request, 'BetaWebKeyServiceDeleteWebKeyRequest')
        invoke_api_for_result(
          :POST, path, query_params, header_params, request_body,
          ['application/json'],
          'application/json',
      ...
      def list_web_keys(body)
        if body.nil?
          raise ArgumentError,
                "Missing the required parameter 'body' when calling BetaWebKeyServiceApi.list_web_keys"
        end
