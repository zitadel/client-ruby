...
module Zitadel::Client::Api
  ...
  @api_client = api_client
    ...
    data, _status_code, _headers = create_session_with_http_info(beta_session_service_create_session_request, opts)
    data
    end
      ...
      # Create a new session
          # @param beta_session_service_create_session_request [BetaSessionServiceCreateSessionRequest] 
      # @param [Hash] opts the optional parameters
    # @return [Array<(BetaSessionServiceCreateSessionResponse, Integer, Hash)>] BetaSessionServiceCreateSessionResponse data, response status code and response headers
    def create_session_with_http_info(beta_session_service_create_session_request, opts = {})
    ...
    data, _status_code, _headers = delete_session_with_http_info(beta_session_service_delete_session_request, opts)
    data
    end
      ...
      # Terminate a session
          # @param beta_session_service_delete_session_request [BetaSessionServiceDeleteSessionRequest] 
      # @param [Hash] opts the optional parameters
    # @return [Array<(BetaSessionServiceDeleteSessionResponse, Integer, Hash)>] BetaSessionServiceDeleteSessionResponse data, response status code and response headers
    def delete_session_with_http_info(beta_session_service_delete_session_request, opts = {})
    if @api_client.config.debugging
    ...
    data, _status_code, _headers = get_session_with_http_info(beta_session_service_get_session_request, opts)
    data
    end
      ...
      # GetSession a session
          # @param beta_session_service_get_session_request [BetaSessionServiceGetSessionRequest] 
      # @param [Hash] opts the optional parameters
    # @return [Array<(BetaSessionServiceGetSessionResponse, Integer, Hash)>] BetaSessionServiceGetSessionResponse data, response status code and response headers
    def get_session_with_http_info(beta_session_service_get_session_request, opts = {})
    if @api_client.config.debugging
    ...
    data
      ...
      # Search sessions
          # @param beta_session_service_list_sessions_request [BetaSessionServiceListSessionsRequest] 
      # @param [Hash] opts the optional parameters
    # @return [Array<(BetaSessionServiceListSessionsResponse, Integer, Hash)>] BetaSessionServiceListSessionsResponse data, response status code and response headers
    def list_sessions_with_http_info(beta_session_service_list_sessions_request, opts = {})
    if @api_client.config.debugging
    ...
    data, _status_code, _headers = set_session_with_http_info(beta_session_service_set_session_request, opts)
    data
    end
      ...
      # Update a session
          # @param beta_session_service_set_session_request [BetaSessionServiceSetSessionRequest] 
      # @param [Hash] opts the optional parameters
    # @return [Array<(BetaSessionServiceSetSessionResponse, Integer, Hash)>] BetaSessionServiceSetSessionResponse data, response status code and response headers
    def set_session_with_http_info(beta_session_service_set_session_request, opts = {})
    if @api_client.config.debugging
