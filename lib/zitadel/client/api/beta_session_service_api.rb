  ...
  module Api
    ...
    class BetaSessionServiceApi < BaseApi
      ...
      def create_session_with_http_info(beta_session_service_create_session_request)
        ...
        request_body = ::Zitadel::Client::ObjectSerializer.encode_oneof_body(beta_session_service_create_session_request, 'BetaSessionServiceCreateSessionRequest')
      ...
      def delete_session_with_http_info(beta_session_service_delete_session_request)
        ...
        # (primitives, plain models) and for discriminated / model-ref unions,
        # whose resolved value already serializes correctly.
        request_body = ::Zitadel::Client::ObjectSerializer.encode_oneof_body(beta_session_service_delete_session_request, 'BetaSessionServiceDeleteSessionRequest')
        invoke_api_for_result(
          :POST, path, query_params, header_params, request_body,
          ['application/json'],
          'application/json',
      ...
      def get_session_with_http_info(beta_session_service_get_session_request)
        ...
        # (primitives, plain models) and for discriminated / model-ref unions,
        # whose resolved value already serializes correctly.
        request_body = ::Zitadel::Client::ObjectSerializer.encode_oneof_body(beta_session_service_get_session_request, 'BetaSessionServiceGetSessionRequest')
        invoke_api_for_result(
          :POST, path, query_params, header_params, request_body,
          ['application/json'],
          'application/json',
      ...
      def list_sessions_with_http_info(beta_session_service_list_sessions_request)
        ...
        # (primitives, plain models) and for discriminated / model-ref unions,
        # whose resolved value already serializes correctly.
        request_body = ::Zitadel::Client::ObjectSerializer.encode_oneof_body(beta_session_service_list_sessions_request, 'BetaSessionServiceListSessionsRequest')
        invoke_api_for_result(
          :POST, path, query_params, header_params, request_body,
          ['application/json'],
          'application/json',
      ...
      def set_session_with_http_info(beta_session_service_set_session_request)
        ...
        # (primitives, plain models) and for discriminated / model-ref unions,
        # whose resolved value already serializes correctly.
        request_body = ::Zitadel::Client::ObjectSerializer.encode_oneof_body(beta_session_service_set_session_request, 'BetaSessionServiceSetSessionRequest')
        invoke_api_for_result(
          :POST, path, query_params, header_params, request_body,
          ['application/json'],
          'application/json',
