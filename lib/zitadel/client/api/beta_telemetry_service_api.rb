  ...
  module Api
    ...
    class BetaTelemetryServiceApi < BaseApi
      ...
      def report_base_information_with_http_info(beta_telemetry_service_report_base_information_request)
        ...
        request_body = ::Zitadel::Client::ObjectSerializer.encode_oneof_body(beta_telemetry_service_report_base_information_request, 'BetaTelemetryServiceReportBaseInformationRequest')
      ...
      def report_resource_counts_with_http_info(beta_telemetry_service_report_resource_counts_request)
        ...
        # (primitives, plain models) and for discriminated / model-ref unions,
        # whose resolved value already serializes correctly.
        request_body = ::Zitadel::Client::ObjectSerializer.encode_oneof_body(beta_telemetry_service_report_resource_counts_request, 'BetaTelemetryServiceReportResourceCountsRequest')
        invoke_api_for_result(
          :POST, path, query_params, header_params, request_body,
          ['application/json'],
          'application/json',
