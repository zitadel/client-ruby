...
module Zitadel::Client::Api
  ...
  @api_client = api_client
    ...
    data, _status_code, _headers = create_response_with_http_info(saml_service_create_response_request, opts)
    data
    end
    ...
    def create_response_with_http_info(saml_service_create_response_request, opts = {})
    ...
    data, _status_code, _headers = get_saml_request_with_http_info(saml_service_get_saml_request_request, opts)
    data
    end
    ...
    def get_saml_request_with_http_info(saml_service_get_saml_request_request, opts = {})
    if @api_client.config.debugging
