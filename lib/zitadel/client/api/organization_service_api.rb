...
module Zitadel::Client::Api
  ...
  @api_client = api_client
    ...
    data, _status_code, _headers = add_organization_with_http_info(organization_service_add_organization_request, opts)
    data
    end
    ...
    def add_organization_with_http_info(organization_service_add_organization_request, opts = {})
    ...
    data, _status_code, _headers = list_organizations_with_http_info(organization_service_list_organizations_request, opts)
    data
    end
    ...
    def list_organizations_with_http_info(organization_service_list_organizations_request, opts = {})
    if @api_client.config.debugging
