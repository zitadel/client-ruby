  ...
  module Api
    ...
    class OIDCServiceApi < BaseApi
      ...
      def authorize_or_deny_device_authorization_with_http_info(oidc_service_authorize_or_deny_device_authorization_request)
        ...
        request_body = ::Zitadel::Client::ObjectSerializer.encode_oneof_body(oidc_service_authorize_or_deny_device_authorization_request, 'OIDCServiceAuthorizeOrDenyDeviceAuthorizationRequest')
      ...
      def create_callback_with_http_info(oidc_service_create_callback_request)
        ...
        # (primitives, plain models) and for discriminated / model-ref unions,
        # whose resolved value already serializes correctly.
        request_body = ::Zitadel::Client::ObjectSerializer.encode_oneof_body(oidc_service_create_callback_request, 'OIDCServiceCreateCallbackRequest')
        invoke_api_for_result(
          :POST, path, query_params, header_params, request_body,
          ['application/json'],
          'application/json',
      ...
      def get_auth_request_with_http_info(oidc_service_get_auth_request_request)
        ...
        # (primitives, plain models) and for discriminated / model-ref unions,
        # whose resolved value already serializes correctly.
        request_body = ::Zitadel::Client::ObjectSerializer.encode_oneof_body(oidc_service_get_auth_request_request, 'OIDCServiceGetAuthRequestRequest')
        invoke_api_for_result(
          :POST, path, query_params, header_params, request_body,
          ['application/json'],
          'application/json',
      ...
      def get_device_authorization_request_with_http_info(oidc_service_get_device_authorization_request_request)
        ...
        # (primitives, plain models) and for discriminated / model-ref unions,
        # whose resolved value already serializes correctly.
        request_body = ::Zitadel::Client::ObjectSerializer.encode_oneof_body(oidc_service_get_device_authorization_request_request, 'OIDCServiceGetDeviceAuthorizationRequestRequest')
        invoke_api_for_result(
          :POST, path, query_params, header_params, request_body,
          ['application/json'],
          'application/json',
