  ...
  module Api
    ...
    class SessionServiceApi < BaseApi
      ...
      def create_session_with_http_info(session_service_create_session_request)
        ...
        request_body = ::Zitadel::Client::ObjectSerializer.encode_oneof_body(session_service_create_session_request, 'SessionServiceCreateSessionRequest')
      ...
      def delete_session_with_http_info(session_service_delete_session_request)
        ...
        # (primitives, plain models) and for discriminated / model-ref unions,
        # whose resolved value already serializes correctly.
        request_body = ::Zitadel::Client::ObjectSerializer.encode_oneof_body(session_service_delete_session_request, 'SessionServiceDeleteSessionRequest')
        invoke_api_for_result(
          :POST, path, query_params, header_params, request_body,
          ['application/json'],
          'application/json',
      ...
      def get_session_with_http_info(session_service_get_session_request)
        ...
        # (primitives, plain models) and for discriminated / model-ref unions,
        # whose resolved value already serializes correctly.
        request_body = ::Zitadel::Client::ObjectSerializer.encode_oneof_body(session_service_get_session_request, 'SessionServiceGetSessionRequest')
        invoke_api_for_result(
          :POST, path, query_params, header_params, request_body,
          ['application/json'],
          'application/json',
      ...
      def list_sessions_with_http_info(session_service_list_sessions_request)
        ...
        # (primitives, plain models) and for discriminated / model-ref unions,
        # whose resolved value already serializes correctly.
        request_body = ::Zitadel::Client::ObjectSerializer.encode_oneof_body(session_service_list_sessions_request, 'SessionServiceListSessionsRequest')
        invoke_api_for_result(
          :POST, path, query_params, header_params, request_body,
          ['application/json'],
          'application/json',
      ...
      def set_session_with_http_info(session_service_set_session_request)
        ...
        # (primitives, plain models) and for discriminated / model-ref unions,
        # whose resolved value already serializes correctly.
        request_body = ::Zitadel::Client::ObjectSerializer.encode_oneof_body(session_service_set_session_request, 'SessionServiceSetSessionRequest')
        invoke_api_for_result(
          :POST, path, query_params, header_params, request_body,
          ['application/json'],
          'application/json',
