  ...
  module Api
    ...
    class WebKeyServiceApi < BaseApi
      ...
      def activate_web_key_with_http_info(web_key_service_activate_web_key_request)
        ...
        request_body = ::Zitadel::Client::ObjectSerializer.encode_oneof_body(web_key_service_activate_web_key_request, 'WebKeyServiceActivateWebKeyRequest')
      ...
      def create_web_key_with_http_info(web_key_service_create_web_key_request)
        ...
        # (primitives, plain models) and for discriminated / model-ref unions,
        # whose resolved value already serializes correctly.
        request_body = ::Zitadel::Client::ObjectSerializer.encode_oneof_body(web_key_service_create_web_key_request, 'WebKeyServiceCreateWebKeyRequest')
        invoke_api_for_result(
          :POST, path, query_params, header_params, request_body,
          ['application/json'],
          'application/json',
      ...
      def delete_web_key_with_http_info(web_key_service_delete_web_key_request)
        ...
        # (primitives, plain models) and for discriminated / model-ref unions,
        # whose resolved value already serializes correctly.
        request_body = ::Zitadel::Client::ObjectSerializer.encode_oneof_body(web_key_service_delete_web_key_request, 'WebKeyServiceDeleteWebKeyRequest')
        invoke_api_for_result(
          :POST, path, query_params, header_params, request_body,
          ['application/json'],
          'application/json',
