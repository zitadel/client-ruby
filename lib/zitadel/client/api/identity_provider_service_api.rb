...
module Zitadel::Client::Api
  ...
  @api_client = api_client
    ...
    data, _status_code, _headers = get_idpby_id_with_http_info(identity_provider_service_get_idpby_id_request, opts)
    data
    end
    ...
    def get_idpby_id_with_http_info(identity_provider_service_get_idpby_id_request, opts = {})
