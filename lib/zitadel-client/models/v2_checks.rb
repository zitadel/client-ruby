...
module ZitadelClient
  class V2Checks
    ...
    def self.openapi_types
      {
        :'user' => :'V2CheckUser',
        :'password' => :'V2CheckPassword',
        :'web_auth_n' => :'V2CheckWebAuthN',
        :'idp_intent' => :'V2CheckIDPIntent',
        :'totp' => :'V2CheckTOTP',
        :'otp_sms' => :'V2CheckOTP',
        :'otp_email' => :'V2CheckOTP'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ZitadelClient::V2Checks` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ZitadelClient::V2Checks`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
