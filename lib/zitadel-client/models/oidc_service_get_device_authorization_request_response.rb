...
module Model # Added Model module
    ...
    attr_accessor :device_authorization_request
    ...
    def self.openapi_types
      {
        :'device_authorization_request' => :'OIDCServiceDeviceAuthorizationRequest'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `ZitadelClient::Model::OIDCServiceGetDeviceAuthorizationRequestResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `ZitadelClient::Model::OIDCServiceGetDeviceAuthorizationRequestResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'device_authorization_request')
        self.device_authorization_request = attributes[:'device_authorization_request']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          device_authorization_request == o.device_authorization_request
    end
    ...
    def hash
      [device_authorization_request].hash
    end
