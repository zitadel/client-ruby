...
module Model # Added Model module
    ...
    def self.openapi_types
      {
        :'execution_paths' => :'Array<FeatureServiceImprovedPerformance>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `ZitadelClient::Model::FeatureServiceImprovedPerformanceFeatureFlag` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `ZitadelClient::Model::FeatureServiceImprovedPerformanceFeatureFlag`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'execution_paths')
        if (value = attributes[:'execution_paths']).is_a?(Array)
          self.execution_paths = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          execution_paths == o.execution_paths &&
          source == o.source
    end
