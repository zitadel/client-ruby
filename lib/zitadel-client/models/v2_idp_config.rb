...
module ZitadelClient
  class V2IDPConfig
    ...
    def self.openapi_types
      {
        :'options' => :'Zitadelidpv2Options',
        :'ldap' => :'V2LDAPConfig',
        :'google' => :'V2GoogleConfig',
        :'oauth' => :'V2OAuthConfig',
        :'oidc' => :'V2GenericOIDCConfig',
        :'jwt' => :'V2JWTConfig',
        :'github' => :'V2GitHubConfig',
        :'github_es' => :'V2GitHubEnterpriseServerConfig',
        :'gitlab' => :'V2GitLabConfig',
        :'gitlab_self_hosted' => :'V2GitLabSelfHostedConfig',
        :'azure_ad' => :'V2AzureADConfig',
        :'apple' => :'V2AppleConfig',
        :'saml' => :'V2SAMLConfig'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ZitadelClient::V2IDPConfig` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ZitadelClient::V2IDPConfig`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
