...
module Model # Added Model module
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `ZitadelClient::Model::IdentityProviderServiceJWTConfig` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `ZitadelClient::Model::IdentityProviderServiceJWTConfig`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'jwt_endpoint')
        self.jwt_endpoint = attributes[:'jwt_endpoint']
      end
      ...
      if attributes.key?(:'keys_endpoint')
        self.keys_endpoint = attributes[:'keys_endpoint']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          jwt_endpoint == o.jwt_endpoint &&
          issuer == o.issuer &&
          keys_endpoint == o.keys_endpoint &&
