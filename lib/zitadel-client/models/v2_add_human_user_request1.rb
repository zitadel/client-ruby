  ...
  class V2AddHumanUserRequest1
    ...
    def self.openapi_types
      {
        ...
        :'phone' => :'V2SetHumanPhone1',
        :'metadata' => :'Array<V2SetMetadataEntry1>',
        :'password' => :'V2Password',
        :'hashed_password' => :'V2HashedPassword',
        :'idp_links' => :'Array<V2IDPLink>',
        :'totp_secret' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ZitadelClient::V2AddHumanUserRequest1` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ZitadelClient::V2AddHumanUserRequest1`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
