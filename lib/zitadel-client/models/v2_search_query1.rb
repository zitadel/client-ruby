...
module ZitadelClient
  class V2SearchQuery1
    ...
    def self.openapi_types
      {
        :'user_name_query' => :'V2UserNameQuery',
        :'first_name_query' => :'V2FirstNameQuery',
        :'last_name_query' => :'V2LastNameQuery',
        :'nick_name_query' => :'V2NickNameQuery',
        :'display_name_query' => :'V2DisplayNameQuery',
        :'email_query' => :'V2EmailQuery',
        :'state_query' => :'V2StateQuery',
        :'type_query' => :'V2TypeQuery',
        :'login_name_query' => :'V2LoginNameQuery',
        :'in_user_ids_query' => :'V2InUserIDQuery',
        :'or_query' => :'V2OrQuery',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ZitadelClient::V2SearchQuery1` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ZitadelClient::V2SearchQuery1`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
