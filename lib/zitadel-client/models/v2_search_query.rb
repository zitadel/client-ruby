...
module ZitadelClient
  class V2SearchQuery
    ...
    def self.openapi_types
      {
        :'ids_query' => :'V2IDsQuery',
        :'user_id_query' => :'V2UserIDQuery',
        :'creation_date_query' => :'V2CreationDateQuery',
        :'creator_query' => :'V2CreatorQuery',
        :'user_agent_query' => :'V2UserAgentQuery'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ZitadelClient::V2SearchQuery` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ZitadelClient::V2SearchQuery`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
