...
module Model # Added Model module
    ...
    def self.attribute_map
      {
        ...
        :'enable_impersonation' => :'enableImpersonation'
      }
    end
    ...
    def self.openapi_types
      {
        :'embedded_iframe' => :'SettingsServiceEmbeddedIframeSettings',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `ZitadelClient::Model::SettingsServiceSetSecuritySettingsRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `ZitadelClient::Model::SettingsServiceSetSecuritySettingsRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'embedded_iframe')
        self.embedded_iframe = attributes[:'embedded_iframe']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          embedded_iframe == o.embedded_iframe &&
          enable_impersonation == o.enable_impersonation
    end
    ...
    def hash
      [embedded_iframe, enable_impersonation].hash
    end
