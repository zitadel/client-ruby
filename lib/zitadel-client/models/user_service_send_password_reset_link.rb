...
module Model # Added Model module
    ...
    def self.openapi_types
      {
        :'notification_type' => :'UserServiceNotificationType',
        :'url_template' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `ZitadelClient::Model::UserServiceSendPasswordResetLink` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `ZitadelClient::Model::UserServiceSendPasswordResetLink`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'notification_type')
        ...
        self.notification_type = 'NOTIFICATION_TYPE_Unspecified'
      end
    ...
    def hash
      [notification_type, url_template].hash
    end
