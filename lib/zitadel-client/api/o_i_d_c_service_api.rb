  ...
  class OIDCServiceApi
    ...
    def o_idc_service_authorize_or_deny_device_authorization_with_http_info(device_authorization_id, oidc_service_authorize_or_deny_device_authorization_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OIDCServiceApi.o_idc_service_authorize_or_deny_device_authorization ...'
      end
      ...
      if @api_client.config.client_side_validation && device_authorization_id.nil?
        fail ArgumentError, "Missing the required parameter 'device_authorization_id' when calling OIDCServiceApi.o_idc_service_authorize_or_deny_device_authorization"
      end
      ...
      if @api_client.config.client_side_validation && oidc_service_authorize_or_deny_device_authorization_request.nil?
        fail ArgumentError, "Missing the required parameter 'oidc_service_authorize_or_deny_device_authorization_request' when calling OIDCServiceApi.o_idc_service_authorize_or_deny_device_authorization"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"OIDCServiceApi.o_idc_service_authorize_or_deny_device_authorization",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OIDCServiceApi#o_idc_service_authorize_or_deny_device_authorization\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def o_idc_service_create_callback_with_http_info(auth_request_id, oidc_service_create_callback_request, opts = {})
      ...
      if @api_client.config.client_side_validation && oidc_service_create_callback_request.nil?
        fail ArgumentError, "Missing the required parameter 'oidc_service_create_callback_request' when calling OIDCServiceApi.o_idc_service_create_callback"
      end
      # resource path
    ...
    def o_idc_service_get_device_authorization_request_with_http_info(user_code, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OIDCServiceApi.o_idc_service_get_device_authorization_request ...'
      end
      # verify the required parameter 'user_code' is set
      if @api_client.config.client_side_validation && user_code.nil?
        fail ArgumentError, "Missing the required parameter 'user_code' when calling OIDCServiceApi.o_idc_service_get_device_authorization_request"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"OIDCServiceApi.o_idc_service_get_device_authorization_request",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OIDCServiceApi#o_idc_service_get_device_authorization_request\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
