...
module ZitadelClient
  ...
  module Model
    class IdentityProviderServiceGenericOIDCConfig
      ...
      attr_accessor :is_id_token_mapping
      ...
      def initialize(attributes = {})
        unless attributes.is_a?(Hash)
          ...
          raise ArgumentError,
                'The input argument (attributes) must be a hash in `ZitadelClient::Model::IdentityProviderServiceGenericOIDCConfig` initialize method'
        end
        ...
        attributes = attributes.each_with_object({}) do |(k, v), h|
          unless acceptable_attribute_map.key?(k.to_sym)
            # MODIFIED: Updated class name in error message
            raise ArgumentError,
                  "`#{k}` is not a valid attribute in `ZitadelClient::Model::IdentityProviderServiceGenericOIDCConfig`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
          end

          h[k.to_sym] = v
        end

        self.issuer = attributes[:issuer] if attributes.key?(:issuer)
        ...
        return unless attributes.key?(:is_id_token_mapping)

        self.is_id_token_mapping = attributes[:is_id_token_mapping]
      end
      ...
      def ==(other)
        ...
        self.class == other.class &&
          ...
          scopes == other.scopes &&
          is_id_token_mapping == other.is_id_token_mapping
      end
      ...
      def hash
        [issuer, client_id, scopes, is_id_token_mapping].hash
      end
