...
module ZitadelClient
  ...
  module Model
    class IdentityProviderServiceAzureADConfig
      attr_accessor :client_id, :tenant
      ...
      def initialize(attributes = {})
        unless attributes.is_a?(Hash)
          ...
          raise ArgumentError,
                'The input argument (attributes) must be a hash in `ZitadelClient::Model::IdentityProviderServiceAzureADConfig` initialize method'
        end
        ...
        attributes = attributes.each_with_object({}) do |(k, v), h|
          unless acceptable_attribute_map.key?(k.to_sym)
            # MODIFIED: Updated class name in error message
            raise ArgumentError,
                  "`#{k}` is not a valid attribute in `ZitadelClient::Model::IdentityProviderServiceAzureADConfig`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
          end
        ...
        self.tenant = attributes[:tenant] if attributes.key?(:tenant)

        self.email_verified = attributes[:email_verified] if attributes.key?(:email_verified)
      ...
      def hash
        [client_id, tenant, email_verified, scopes].hash
      end
