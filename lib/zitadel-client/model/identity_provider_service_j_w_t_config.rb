    ...
    class IdentityProviderServiceJWTConfig
      ...
      def initialize(attributes = {})
        unless attributes.is_a?(Hash)
          ...
          raise ArgumentError,
                'The input argument (attributes) must be a hash in `ZitadelClient::Model::IdentityProviderServiceJWTConfig` initialize method'
        end
        ...
        attributes = attributes.each_with_object({}) do |(k, v), h|
          unless acceptable_attribute_map.key?(k.to_sym)
            # MODIFIED: Updated class name in error message
            raise ArgumentError,
                  "`#{k}` is not a valid attribute in `ZitadelClient::Model::IdentityProviderServiceJWTConfig`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
          end

          h[k.to_sym] = v
        end

        self.jwt_endpoint = attributes[:jwt_endpoint] if attributes.key?(:jwt_endpoint)

        self.issuer = attributes[:issuer] if attributes.key?(:issuer)

        self.keys_endpoint = attributes[:keys_endpoint] if attributes.key?(:keys_endpoint)

        return unless attributes.key?(:header_name)
      ...
      def ==(other)
        ...
        self.class == other.class &&
          jwt_endpoint == other.jwt_endpoint &&
          issuer == other.issuer &&
          keys_endpoint == other.keys_endpoint &&
      ...
      def hash
        [jwt_endpoint, issuer, keys_endpoint, header_name].hash
      end
