...
module ZitadelClient
  ...
  module Model
    class IdentityProviderServiceSAMLConfig
      ...
      attr_accessor :binding, :name_id_format
      ...
      def initialize(attributes = {})
        unless attributes.is_a?(Hash)
          ...
          raise ArgumentError,
                'The input argument (attributes) must be a hash in `ZitadelClient::Model::IdentityProviderServiceSAMLConfig` initialize method'
        end
        ...
        attributes = attributes.each_with_object({}) do |(k, v), h|
          unless acceptable_attribute_map.key?(k.to_sym)
            # MODIFIED: Updated class name in error message
            raise ArgumentError,
                  "`#{k}` is not a valid attribute in `ZitadelClient::Model::IdentityProviderServiceSAMLConfig`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
          end

          h[k.to_sym] = v
        end

        self.metadata_xml = attributes[:metadata_xml] if attributes.key?(:metadata_xml)

        self.binding = if attributes.key?(:binding)
                         attributes[:binding]
                       else
                         'SAML_BINDING_UNSPECIFIED'
                       end

        self.with_signed_request = attributes[:with_signed_request] if attributes.key?(:with_signed_request)

        self.name_id_format = if attributes.key?(:name_id_format)
                                attributes[:name_id_format]
                              else
                                'SAML_NAME_ID_FORMAT_UNSPECIFIED'
                              end

        return unless attributes.key?(:transient_mapping_attribute_name)
      ...
      def ==(other)
        ...
        self.class == other.class &&
          metadata_xml == other.metadata_xml &&
          binding == other.binding &&
          with_signed_request == other.with_signed_request &&
          name_id_format == other.name_id_format &&
          transient_mapping_attribute_name == other.transient_mapping_attribute_name
      end
