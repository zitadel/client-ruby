    ...
    class IdentityProviderServiceOptions
      ...
      def initialize(attributes = {})
        unless attributes.is_a?(Hash)
          ...
          raise ArgumentError,
                'The input argument (attributes) must be a hash in `ZitadelClient::Model::IdentityProviderServiceOptions` initialize method'
        end
        ...
        attributes = attributes.each_with_object({}) do |(k, v), h|
          unless acceptable_attribute_map.key?(k.to_sym)
            # MODIFIED: Updated class name in error message
            raise ArgumentError,
                  "`#{k}` is not a valid attribute in `ZitadelClient::Model::IdentityProviderServiceOptions`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
          end

          h[k.to_sym] = v
        end

        self.is_linking_allowed = attributes[:is_linking_allowed] if attributes.key?(:is_linking_allowed)

        self.is_creation_allowed = attributes[:is_creation_allowed] if attributes.key?(:is_creation_allowed)

        self.is_auto_creation = attributes[:is_auto_creation] if attributes.key?(:is_auto_creation)

        self.is_auto_update = attributes[:is_auto_update] if attributes.key?(:is_auto_update)

        self.auto_linking = if attributes.key?(:auto_linking)
                              attributes[:auto_linking]
                            else
      ...
      def ==(other)
        ...
        self.class == other.class &&
          is_linking_allowed == other.is_linking_allowed &&
          is_creation_allowed == other.is_creation_allowed &&
          is_auto_creation == other.is_auto_creation &&
          is_auto_update == other.is_auto_update &&
          auto_linking == other.auto_linking
      end
