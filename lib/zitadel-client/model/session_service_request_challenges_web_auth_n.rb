...
module Model # Added Model module
    ...
    def self.openapi_types
      {
        :'domain' => :'String',
        :'user_verification_requirement' => :'SessionServiceUserVerificationRequirement'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `ZitadelClient::Model::SessionServiceRequestChallengesWebAuthN` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `ZitadelClient::Model::SessionServiceRequestChallengesWebAuthN`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'user_verification_requirement')
        ...
        self.user_verification_requirement = 'USER_VERIFICATION_REQUIREMENT_UNSPECIFIED'
      end
    end
    ...
    def list_invalid_properties
      ...
      if @user_verification_requirement.nil?
        invalid_properties.push('invalid value for "user_verification_requirement", user_verification_requirement cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @user_verification_requirement.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] user_verification_requirement Value to be assigned
    ...
    def ==(o)
      ...
      self.class == o.class &&
          domain == o.domain &&
          user_verification_requirement == o.user_verification_requirement
    end
    ...
    def hash
      [domain, user_verification_requirement].hash
    end
