...
module ZitadelClient
  # Added Model module
  module Model
    class OrganizationServiceAddHumanUserRequest
      ...
      attr_accessor :organization, :profile, :email, :phone, :metadata, :password, :hashed_password, :idp_links
      ...
      def initialize(attributes = {})
        unless attributes.is_a?(Hash)
          ...
          raise ArgumentError,
                'The input argument (attributes) must be a hash in `ZitadelClient::Model::OrganizationServiceAddHumanUserRequest` initialize method'
        end
        ...
        attributes = attributes.each_with_object({}) do |(k, v), h|
          unless acceptable_attribute_map.key?(k.to_sym)
            # MODIFIED: Updated class name in error message
            raise ArgumentError,
                  "`#{k}` is not a valid attribute in `ZitadelClient::Model::OrganizationServiceAddHumanUserRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
          end
        ...
        self.organization = attributes[:organization] if attributes.key?(:organization)
        ...
        if attributes.key?(:metadata) && (value = attributes[:metadata]).is_a?(Array)
          self.metadata = value
        end

        self.password = attributes[:password] if attributes.key?(:password)

        self.hashed_password = attributes[:hashed_password] if attributes.key?(:hashed_password)

        if attributes.key?(:idp_links) && (value = attributes[:idp_links]).is_a?(Array)
          self.idp_links = value
        end

        return unless attributes.key?(:totp_secret)
      ...
      def list_invalid_properties
        ...
        invalid_properties.push('invalid value for "profile", profile cannot be nil.') if @profile.nil?
        ...
        if !@totp_secret.nil? && @totp_secret.to_s.empty?
      ...
      def valid?
        ...
        return false if !@totp_secret.nil? && @totp_secret.to_s.empty?
      ...
      def user_id=(user_id)
        ...
        if user_id.to_s.length > 200
          raise ArgumentError, 'invalid value for "user_id", the character length must be smaller than or equal to 200.'
        end

        if user_id.to_s.empty?
          raise ArgumentError, 'invalid value for "user_id", the character length must be great than or equal to 1.'
        end
      ...
      def username=(username)
        ...
        if username.to_s.length > 200
          raise ArgumentError, 'invalid value for "username", the character length must be smaller than or equal to 200.'
        end

        if username.to_s.empty?
          raise ArgumentError, 'invalid value for "username", the character length must be great than or equal to 1.'
        end
      ...
      def totp_secret=(totp_secret)
        raise ArgumentError, 'totp_secret cannot be nil' if totp_secret.nil?

        if totp_secret.to_s.length > 200
          raise ArgumentError, 'invalid value for "totp_secret", the character length must be smaller than or equal to 200.'
        end

        if totp_secret.to_s.empty?
          raise ArgumentError, 'invalid value for "totp_secret", the character length must be great than or equal to 1.'
        end
      ...
      def ==(other)
        ...
        self.class == other.class &&
          ...
          idp_links == other.idp_links &&
          totp_secret == other.totp_secret
      end
      ...
      def hash
        [user_id, username, organization, profile, email, phone, metadata, password, hashed_password, idp_links,
         totp_secret].hash
      end
