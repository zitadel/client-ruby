    ...
    class FeatureServiceImprovedPerformanceFeatureFlag
      ...
      def initialize(attributes = {})
        unless attributes.is_a?(Hash)
          ...
          raise ArgumentError,
                'The input argument (attributes) must be a hash in `ZitadelClient::Model::FeatureServiceImprovedPerformanceFeatureFlag` initialize method'
        end
        ...
        attributes = attributes.each_with_object({}) do |(k, v), h|
          unless acceptable_attribute_map.key?(k.to_sym)
            # MODIFIED: Updated class name in error message
            raise ArgumentError,
                  "`#{k}` is not a valid attribute in `ZitadelClient::Model::FeatureServiceImprovedPerformanceFeatureFlag`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
          end

          h[k.to_sym] = v
        end

        if attributes.key?(:execution_paths) && (value = attributes[:execution_paths]).is_a?(Array)
          self.execution_paths = value
        end

        self.source = if attributes.key?(:source)
                        attributes[:source]
                      else
                        'SOURCE_UNSPECIFIED'
                      end
      ...
      def ==(other)
        ...
        self.class == other.class &&
          execution_paths == other.execution_paths &&
          source == other.source
      end
