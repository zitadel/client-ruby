...
module ZitadelClient
  # Added Model module
  module Model
    class OrganizationServiceAddOrganizationResponseCreatedAdmin
      attr_accessor :user_id, :email_code, :phone_code
      ...
      def initialize(attributes = {})
        unless attributes.is_a?(Hash)
          ...
          raise ArgumentError,
                'The input argument (attributes) must be a hash in `ZitadelClient::Model::OrganizationServiceAddOrganizationResponseCreatedAdmin` initialize method'
        end
        ...
        attributes = attributes.each_with_object({}) do |(k, v), h|
          unless acceptable_attribute_map.key?(k.to_sym)
            # MODIFIED: Updated class name in error message
            raise ArgumentError,
                  "`#{k}` is not a valid attribute in `ZitadelClient::Model::OrganizationServiceAddOrganizationResponseCreatedAdmin`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
          end
        ...
        self.email_code = attributes[:email_code] if attributes.key?(:email_code)

        return unless attributes.key?(:phone_code)
      ...
      def ==(other)
        ...
        self.class == other.class &&
          ...
          email_code == other.email_code &&
          phone_code == other.phone_code
      end
      ...
      def hash
        [user_id, email_code, phone_code].hash
      end
