...
module Model # Added Model module
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        ...
        fail ArgumentError, "The input argument (attributes) must be a hash in `ZitadelClient::Model::SessionServiceChallengesWebAuthN` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          # MODIFIED: Updated class name in error message
          fail ArgumentError, "`#{k}` is not a valid attribute in `ZitadelClient::Model::SessionServiceChallengesWebAuthN`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'public_key_credential_request_options')
        self.public_key_credential_request_options = attributes[:'public_key_credential_request_options']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          public_key_credential_request_options == o.public_key_credential_request_options
    end
    ...
    def hash
      [public_key_credential_request_options].hash
    end
