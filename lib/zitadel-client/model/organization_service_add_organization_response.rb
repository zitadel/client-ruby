...
module ZitadelClient
  ...
  module Model
    class OrganizationServiceAddOrganizationResponse
      attr_accessor :details, :organization_id, :created_admins
      ...
      def initialize(attributes = {})
        unless attributes.is_a?(Hash)
          ...
          raise ArgumentError,
                'The input argument (attributes) must be a hash in `ZitadelClient::Model::OrganizationServiceAddOrganizationResponse` initialize method'
        end
        ...
        attributes = attributes.each_with_object({}) do |(k, v), h|
          unless acceptable_attribute_map.key?(k.to_sym)
            # MODIFIED: Updated class name in error message
            raise ArgumentError,
                  "`#{k}` is not a valid attribute in `ZitadelClient::Model::OrganizationServiceAddOrganizationResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
          end
        ...
        self.organization_id = attributes[:organization_id] if attributes.key?(:organization_id)

        return unless attributes.key?(:created_admins)

        if (value = attributes[:created_admins]).is_a?(Array)
          self.created_admins = value
        end
      end
      ...
      def ==(other)
        ...
        self.class == other.class &&
          ...
          created_admins == other.created_admins
      end
      ...
      def hash
        [details, organization_id, created_admins].hash
      end
