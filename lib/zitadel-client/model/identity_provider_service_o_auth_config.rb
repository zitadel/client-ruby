    ...
    class IdentityProviderServiceOAuthConfig
      ...
      def initialize(attributes = {})
        unless attributes.is_a?(Hash)
          ...
          raise ArgumentError,
                'The input argument (attributes) must be a hash in `ZitadelClient::Model::IdentityProviderServiceOAuthConfig` initialize method'
        end
        ...
        attributes = attributes.each_with_object({}) do |(k, v), h|
          unless acceptable_attribute_map.key?(k.to_sym)
            # MODIFIED: Updated class name in error message
            raise ArgumentError,
                  "`#{k}` is not a valid attribute in `ZitadelClient::Model::IdentityProviderServiceOAuthConfig`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
          end
        ...
        self.authorization_endpoint = attributes[:authorization_endpoint] if attributes.key?(:authorization_endpoint)

        self.token_endpoint = attributes[:token_endpoint] if attributes.key?(:token_endpoint)

        self.user_endpoint = attributes[:user_endpoint] if attributes.key?(:user_endpoint)

        if attributes.key?(:scopes) && (value = attributes[:scopes]).is_a?(Array)
          self.scopes = value
        end

        return unless attributes.key?(:id_attribute)
      ...
      def ==(other)
        ...
        self.class == other.class &&
          ...
          user_endpoint == other.user_endpoint &&
          scopes == other.scopes &&
      ...
      def hash
        [client_id, authorization_endpoint, token_endpoint, user_endpoint, scopes, id_attribute].hash
      end
