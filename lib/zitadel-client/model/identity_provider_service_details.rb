...
module ZitadelClient
  # Added Model module
  module Model
    class IdentityProviderServiceDetails
      ...
      attr_accessor :resource_owner, :creation_date
      ...
      def initialize(attributes = {})
        unless attributes.is_a?(Hash)
          ...
          raise ArgumentError,
                'The input argument (attributes) must be a hash in `ZitadelClient::Model::IdentityProviderServiceDetails` initialize method'
        end
        ...
        attributes = attributes.each_with_object({}) do |(k, v), h|
          unless acceptable_attribute_map.key?(k.to_sym)
            # MODIFIED: Updated class name in error message
            raise ArgumentError,
                  "`#{k}` is not a valid attribute in `ZitadelClient::Model::IdentityProviderServiceDetails`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
          end
        ...
        self.change_date = attributes[:change_date] if attributes.key?(:change_date)

        self.resource_owner = attributes[:resource_owner] if attributes.key?(:resource_owner)

        return unless attributes.key?(:creation_date)
      ...
      def ==(other)
        ...
        self.class == other.class &&
          ...
          resource_owner == other.resource_owner &&
