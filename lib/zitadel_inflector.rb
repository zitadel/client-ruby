...
module Zitadel
  ...
  #
  # It lives inside the gem's +Zitadel+ module so that nothing under lib claims a
  # top-level constant besides the gem's own module.
  class Inflector < Zeitwerk::Inflector
    # Declaration names that are namespace scaffolding rather than the file's
    # own constant: the module tree the generator nests every file under.
    IGNORED_DECLARATIONS = %w[Zitadel Client Api Auth Errors Models].freeze
